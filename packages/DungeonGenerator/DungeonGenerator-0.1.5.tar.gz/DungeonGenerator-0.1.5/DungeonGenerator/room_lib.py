from Fortuna import *
from DungeonLib.traps import random_trap
from DungeonLib.monsters import Monster, MonsterGroup, MinionGroup, Boss, Villain, ItemEncounter
from DungeonLib.npc import random_dungeon_npc, random_city_npc
from DungeonLib.utilities import cr_adapter
from DungeonLib.treasure import magic_table_f
...
class Room:
    ...
    def __init__(self, cr=1, room_name="Any", make_traps=True):
        ...
        self.xp = self.threat.xp if self.threat.xp else 0
