from Fortuna import *
from DungeonLib.cr import CR
from DungeonLib.treasure import Loot
from DungeonLib.utilities import cr_str
...
class Trap:
    ...
    rank_3_damage = "4d8"
    rank_4_damage = "5d10"
    random_ability = TruffleShuffle(("CON", "STR", "DEX", "CHA", "INT", "WIS"))
    random_trap = FlexCat({
