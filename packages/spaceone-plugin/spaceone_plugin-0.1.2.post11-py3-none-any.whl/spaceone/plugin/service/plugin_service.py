...
class PluginService(BaseService):
    ...
    def get_plugin_endpoint(self, params: dict):
        ...
        req_params.update({'state': 'ACTIVE'})
    ...
    def _get_installed_plugin(self, supervisor, params):
        ...
        plugin_id = params['plugin_id']
        version = params['version']
        installed_plugin = self.plugin_mgr.search_plugin(supervisor_id, plugin_id, version)
    ...
    def _get_installed_ref_plugin(self, supervisor, installed_plugin, params):
        ...
        installed_plugin_ref = self.plugin_ref_mgr.search_plugin(supervisor_id, plugin_id, version)
