...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v1.4.0-alpha.1586284275+g8b655b5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v1.4.0-alpha.1586284275+g8b655b5`
                """)
            else:
                raise
