...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v1.4.0-alpha.1586877815+gdb9bd5f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v1.4.0-alpha.1586877815+gdb9bd5f`
                """)
            else:
                raise
