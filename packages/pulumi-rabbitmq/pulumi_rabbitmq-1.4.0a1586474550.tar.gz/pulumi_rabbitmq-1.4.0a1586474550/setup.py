...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v1.4.0-alpha.1586474550+g319d6bb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v1.4.0-alpha.1586474550+g319d6bb`
                """)
            else:
                raise
