...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v1.4.0-alpha.1586555406+g8a9cf11'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v1.4.0-alpha.1586555406+g8a9cf11`
                """)
            else:
                raise
