...
class PartialSelect:
    ...
    async def one(self, conn=None):
        ...
        # TODO: This should
        return self.model.from_record(records[0])
...
class Insert(Statement):
    ...
    async def fetchrow(self, conn, debug : bool = False):
