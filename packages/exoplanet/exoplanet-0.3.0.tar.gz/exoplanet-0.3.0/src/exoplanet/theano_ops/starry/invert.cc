...
int APPLY_SPECIFIC(invert)(PyArrayObject* input0,    // Array of "cl"
                           PyArrayObject* input1,    // Array of impact parameters "b"
                           PyArrayObject* input2,    // Array of depths "d"
                           PyArrayObject** output0,  // r
                           PyArrayObject** output1,  // drdcl
                           PyArrayObject** output2,  // drdb
                           PyArrayObject** output3   // drdd
) {
