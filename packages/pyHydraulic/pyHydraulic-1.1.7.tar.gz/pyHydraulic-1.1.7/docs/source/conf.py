...
# The suffix(es) of _source filenames.
...
# (_source start file, target name, title,
...
# (_source start file, name, description, authors, manual section).
man_pages = [
...
# (_source start file, target name, title, author,
