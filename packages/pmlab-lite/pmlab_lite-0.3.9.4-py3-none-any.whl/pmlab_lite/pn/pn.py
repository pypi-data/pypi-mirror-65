...
class PetriNet(AbstractPetriNet):
	...
	def get_spnets_initial_marking(self):
		...
		init_mark_vector[self.get_index_initial_places[0]] = 1
		init_mark_vector[self.get_index_initial_places[1]] = 1
		return init_mark_vector
	
	def get_spnets_final_marking(self):
		final_mark_vector = list (numpy.repeat(0, len(self.places)))
		final_mark_vector[self.get_index_final_places[0]] = 1
		final_mark_vector[self.get_index_final_places[1]] = 1
