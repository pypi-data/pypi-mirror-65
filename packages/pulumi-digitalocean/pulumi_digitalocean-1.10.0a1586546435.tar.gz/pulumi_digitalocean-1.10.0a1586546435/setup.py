...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v1.10.0-alpha.1586546435+gfa6e842'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v1.10.0-alpha.1586546435+gfa6e842`
                """)
            else:
                raise
