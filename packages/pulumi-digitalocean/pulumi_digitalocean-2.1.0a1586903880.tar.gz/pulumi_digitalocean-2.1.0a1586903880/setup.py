...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v2.1.0-alpha.1586903880+gcf7c099'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v2.1.0-alpha.1586903880+gcf7c099`
                """)
            else:
                raise
