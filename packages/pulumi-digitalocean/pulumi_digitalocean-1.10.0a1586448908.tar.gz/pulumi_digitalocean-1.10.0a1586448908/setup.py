...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v1.10.0-alpha.1586448908+g4a1365c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v1.10.0-alpha.1586448908+g4a1365c`
                """)
            else:
                raise
