...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v1.10.0-alpha.1586905504+gd7ff914'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v1.10.0-alpha.1586905504+gd7ff914`
                """)
            else:
                raise
