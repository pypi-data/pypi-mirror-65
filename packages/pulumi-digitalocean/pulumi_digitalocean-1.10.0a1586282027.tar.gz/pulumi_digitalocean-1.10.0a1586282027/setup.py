...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v1.10.0-alpha.1586282027+gba9cde1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v1.10.0-alpha.1586282027+gba9cde1`
                """)
            else:
                raise
