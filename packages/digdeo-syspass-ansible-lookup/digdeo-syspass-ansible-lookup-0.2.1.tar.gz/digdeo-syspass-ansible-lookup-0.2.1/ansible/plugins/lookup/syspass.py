...
class LookupModule(LookupBase):
    ...
    def _ensure_user_group_id_exist(self, customer=None, customer_desc=None):
        ...
        if customer is not None and type(customer) != str and type(customer) != AnsibleUnicode and type(customer) != AnsibleUnsafeText:
    ...
    def _ensure_category_id_exist(self, category=None):
        ...
        if category is not None and type(category) != str and type(category) != AnsibleUnicode and type(category) != AnsibleUnsafeText:
