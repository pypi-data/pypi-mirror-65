...
import ast
from pseutopy.classes.arithmetic import *
from pseutopy.classes.boolean import *
from pseutopy.classes.controls import *
from pseutopy.classes.functions import *
from pseutopy.classes.keywords import *
from pseutopy.classes.lists import *
from pseutopy.classes.statements import *
from pseutopy.classes.values import *
...
class PseuToPy:
    def __init__(self):
        ...
        self.pseudo_mm = metamodel_from_file('./pseutopy/grammar/pseudocode.tx',
                                             classes=[
                                                 # Values
                                                 Num,
                                                 Name,
