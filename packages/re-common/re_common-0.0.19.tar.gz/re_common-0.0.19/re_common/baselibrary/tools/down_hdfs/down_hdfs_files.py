...
class DownHdfs(object):
    ...
    def set_basehdfs(self):
        self.basehdfs = BaseHDFS()
        self.basehdfs.hdfsdir = self.dicts["PathPair"][0][0]
        self.basehdfs.localdir = self.dicts["PathPair"][0][1]
    ...
    def use(self):
        self.read_toml().set_basehdfs().down_files()
