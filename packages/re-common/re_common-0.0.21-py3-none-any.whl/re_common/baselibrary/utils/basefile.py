...
class BaseFile(_io.TextIOWrapper):
    ...
    @classmethod
    def change_file(cls, filepath, size=2 * 1024 * 1024 * 1024):
        """
        ...
        """
        import random
        path = cls.get_file_absolute(filepath).replace(("." + cls.get_file_ext_name(filepath)),
                                                       ("_" + repr(random.randrange(111, 999)) + ".big_json"))
