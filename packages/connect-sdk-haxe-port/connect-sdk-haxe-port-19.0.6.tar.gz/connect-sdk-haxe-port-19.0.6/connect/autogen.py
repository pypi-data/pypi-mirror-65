...
class connect_logger_Logger(connect_Base):
    ...
    __slots__ = ("path", "level", "handlers", "sections", "maskedFields")
    _hx_fields = ["path", "level", "handlers", "sections", "maskedFields"]
    _hx_methods = ["getPath", "getLevel", "setFilename", "getFilename", "getOutputs", "openSection", "closeSection", "writeBlock", "writeCodeBlock", "writeList", "writeTable", "write", "getMaskedFields", "log", "debug", "info", "notice", "warning", "error", "critical", "alert", "emergency", "_writeToHandler", "writeSections"]
...
class connect_logger_LoggerConfig(connect_Base):
    ...
    __slots__ = ("path_", "level_", "handlers_", "maskedFields_", "levelTranslation")
    _hx_fields = ["path_", "level_", "handlers_", "maskedFields_", "levelTranslation"]
    _hx_methods = ["path", "level", "handlers", "maskedFields"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_Base
    ...
    def level(self,level):
        self.level_ = connect_logger_Logger.LEVEL_INFO
        if Std._hx_is(level,Int):
            self.level_ = level
        elif (Std._hx_is(level,str) and (level in self.levelTranslation.h)):
...
class connect_util_Util:
    ...
    __slots__ = ()
    _hx_statics = ["beautify", "beautifyObject", "maskFields", "isJson", "isJsonObject", "isJsonArray", "isArray", "isStruct", "createObjectDiff", "addIdsToObject", "compactArray"]
    ...
    def beautifyObject(obj,compact):
        if compact:
            return haxe_format_JsonPrinter.print(connect_util_Util.maskFields(obj),None,"  ")
        else:
