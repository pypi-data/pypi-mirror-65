...
"""
VERSION = '0.0.11'
LAST_MODIFIED_DATE = '2020-04-12' # by RJH — when setup.py was modified below
...
Note that this app can be run from using the command:
        Bible2USX.py path/to/BibleFileOrFolder

You can discover the version with
        `Bible2USX.py --version`

You can discover the available command line parameters with
        Bible2USX.py --help

    e.g., for verbose mode
        Bible2USX.py --verbose path/to/BibleFileOrFolder
    or using the abbreviated option
        Bible2USX.py -v path/to/BibleFileOrFolder
...
#    long_description=long_description,
    ...
    keywords="Bible check import export index book chapter verse USFM USX",
