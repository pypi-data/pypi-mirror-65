    ...
    def loadData( self, XMLFolder=None ):
        ...
        if not self.__DataDict: # Don't do this unnecessarily
            if XMLFolder is None:
                ...
                standardXMLFileOrFilepath = BibleOrgSysGlobals.BOS_DATA_FILES_FOLDERPATH.joinpath( 'BiblePunctuationSystems.xml' )
                ...
                if pickleIsNewer:
                    ...
                    print( "BiblePunctuationSystems pickle file can't be loaded!" )
                standardJsonFilepath = BibleOrgSysGlobals.BOS_DERIVED_DATA_FILES_FOLDERPATH.joinpath( 'BiblePunctuationSystems_Tables.json' )
                ...
                and os.stat(standardJsonFilepath).st_ctime > os.stat(standardXMLFileOrFilepath).st_ctime: # There's a newer pickle file
                    ...
                    print( "BiblePunctuationSystems JSON file can't be loaded!" )
