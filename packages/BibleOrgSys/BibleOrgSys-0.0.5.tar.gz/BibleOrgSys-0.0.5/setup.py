...
setup(
    ...
    data_files=[
                ...
                # ('BibleOrgSys/DataFiles', [
                #     'BibleOrgSys/DataFiles/BibleBooksCodes.xml', 'BibleOrgSys/DataFiles/BibleBooksCodes.rnc',
                #     'BibleOrgSys/DataFiles/BibleOrganisationalSystems.xml', 'BibleOrgSys/DataFiles/BibleOrganisationalSystems.rnc',
                #     'BibleOrgSys/DataFiles/iso_639_3.xml', 'BibleOrgSys/DataFiles/iso_639_3.rnc',
                #     'BibleOrgSys/DataFiles/USFM2Markers.xml', 'BibleOrgSys/DataFiles/USFM2Markers.rnc',
                #     'BibleOrgSys/DataFiles/USFM3Markers.xml', 'BibleOrgSys/DataFiles/USFM3Markers.rnc',
                #     ]),
                # ('BibleOrgSys/DataFiles/BookNames', [
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames.rnc',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_deu_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_dut_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_eng_deuterocanon.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_eng_extensive.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_eng_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_fra_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_mbt.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_por_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_rus_traditional.xml',
                #     'BibleOrgSys/DataFiles/BookNames/BibleBooksNames_spa_traditional.xml',
                #     ]),
                # ('BibleOrgSys/DataFiles/BookOrders', [
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder.rnc',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_ALL.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_ArmenianNewTestament.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_EthiopianProtestantBible.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_EuropeanBible.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_GutenbergNewTestament.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_HebrewLetteris.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_HebrewStuttgart.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_KJVwithApocrypha.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_Leningradensis.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_LutheranBible.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_MasoreticText.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_ModernJewish.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_NRSVwithApocrypha.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_Septuagint.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_SynodalBible.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_SyriacNewTestament.xml',
                #     'BibleOrgSys/DataFiles/BookOrders/BibleBookOrder_VulgateBible.xml',
                #     ]),
                # ('BibleOrgSys/DataFiles/PunctuationSystems', [
                #     'BibleOrgSys/DataFiles/PunctuationSystems/BiblePunctuationSystem.rnc',
                #     'BibleOrgSys/DataFiles/PunctuationSystems/BiblePunctuationSystem_English_brief.xml',
                #     'BibleOrgSys/DataFiles/PunctuationSystems/BiblePunctuationSystem_English.xml',
                #     'BibleOrgSys/DataFiles/PunctuationSystems/BiblePunctuationSystem_Matigsalug.xml',
                #     ]),
                # ('BibleOrgSys/DataFiles/VersificationSystems', [
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem.rnc',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_BibMaxRef.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_CatholicEsther16.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Catholic.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Cebuano_BUGV.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_DutchTraditional.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_GNT92.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_GNTUK.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_KJV.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Luther.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_NIV84.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_NLT96.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_NRS89.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_NRSV.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Original.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Rahlfs.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_REB89.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_RSV52.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_RussianCanonical.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_RussianOrthodox.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Septuagint.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Spanish.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Synodal.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Syriac.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Vulgate1.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Vulgate2.xml',
                #     'BibleOrgSys/DataFiles/VersificationSystems/BibleVersificationSystem_Vulgate.xml',
                #     ]),
                ],
...
NOTE: This packaging is still being tested, and not necessarily fully functional
until it is marked as v0.1.0 or higher.
At that point, we also expect to release a Snap version.

This software forms the basis of the online Bible Drop Box service
hosted at http://Freely-Given.org/Software/BibleDropBox/.

This software has been tested on hundreds of Bible filesets,
