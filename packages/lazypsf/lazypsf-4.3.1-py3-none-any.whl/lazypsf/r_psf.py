...
def mag_dist(mag_l, mag_u, exp_time=30, pix_size=1.24, CF = 1.51372*10**13):
    """
    Ry Cutter 2019
    ...
    flux distribution params
    """
    ### using m - m_0 = -2.5log_10(F/(CF * exp_time * pix_size))
    ### m_0 = 0
    ### F = 10**(-mag/2.5) * exp_time * (pix_size)* CF
    ...
    for i in range(50):
        ...
        dist[i][0] = 1./50.
        dist[i][1] = 10**(-mag/2.5) * CF* (exp_time * pix_size)
...
def write_mag(exp_time=30, pix_size=1.24, CF = 1.51372*10**13):
    """
    Ry Cutter 2019
