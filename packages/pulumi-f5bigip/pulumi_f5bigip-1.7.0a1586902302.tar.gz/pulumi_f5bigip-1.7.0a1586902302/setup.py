...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v1.7.0-alpha.1586902302+gc628e51'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v1.7.0-alpha.1586902302+gc628e51`
                """)
            else:
                raise
