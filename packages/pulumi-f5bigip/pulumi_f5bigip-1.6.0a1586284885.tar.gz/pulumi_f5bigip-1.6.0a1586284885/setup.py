...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v1.6.0-alpha.1586284885+gf4f5511'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v1.6.0-alpha.1586284885+gf4f5511`
                """)
            else:
                raise
