...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v1.6.0-alpha.1586541556+g8c596ef'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v1.6.0-alpha.1586541556+g8c596ef`
                """)
            else:
                raise
