...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v2.1.0-alpha.1586900917+ga66d413'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v2.1.0-alpha.1586900917+ga66d413`
                """)
            else:
                raise
