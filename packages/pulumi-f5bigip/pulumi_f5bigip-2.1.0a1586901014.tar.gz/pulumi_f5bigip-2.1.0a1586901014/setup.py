...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v2.1.0-alpha.1586901014+g761e7db'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v2.1.0-alpha.1586901014+g761e7db`
                """)
            else:
                raise
