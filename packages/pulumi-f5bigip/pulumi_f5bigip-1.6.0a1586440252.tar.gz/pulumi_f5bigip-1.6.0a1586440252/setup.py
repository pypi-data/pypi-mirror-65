...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v1.6.0-alpha.1586440252+gaea5ad4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v1.6.0-alpha.1586440252+gaea5ad4`
                """)
            else:
                raise
