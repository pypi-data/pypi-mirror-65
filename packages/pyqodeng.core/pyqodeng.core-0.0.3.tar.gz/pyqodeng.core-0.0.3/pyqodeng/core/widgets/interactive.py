...
from pyqodeng.core.managers.decorations import TextDecorationsManager
from pyqodeng.core.managers.panels import PanelsManager
...
class InteractiveConsole(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        from pyqodeng.core.panels import SearchAndReplacePanel
