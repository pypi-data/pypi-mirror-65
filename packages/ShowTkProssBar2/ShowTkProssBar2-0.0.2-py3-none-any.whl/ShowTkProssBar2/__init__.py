...
class ShowTkProssBar2(): 
    def __init__(self, root,wd=400,hd=100,posx=80,posy=60,barwd = 20, step = 1,color='blue'):
        self.i = 0
        self.step = step 
        self.color = color
        self.wd = wd
    ...
    def loop(self):       
        ...
        if 10*self.i <= self.wd - 20:
            self.rec = self.cv.create_rectangle(0,0,10*self.i,20,fill= self.color)
