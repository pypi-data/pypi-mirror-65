...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.32.1", __name__, "aws-elasticloadbalancingv2-targets@1.32.1.jsii.tgz")
