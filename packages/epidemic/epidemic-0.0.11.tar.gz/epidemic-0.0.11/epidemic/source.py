...
def example():
    ...
    correct, prediction, epi = Predict_Epidemic(year)

    if epi != None and epi != 'no':
        print(colored(f'In {year}, {epi} happened.', 'red'))

    elif epi == 'no':
        print(colored(f'In {year}, there\'s no major epidemic happened', 'green'))

    elif epi == None and prediction == 0:
        print(colored(f'In {year}, there\'s {correct * 100}% that an epidemic may NOT happen', 'green'))

    elif epi == None and prediction == 1:
        print(colored(f'In {year}, there\'s {correct * 100}% that an epidemic may happen', 'red'))