...
class CodeBindingExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [CodeBindingExists.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/schemas.html#Schemas.Waiter.CodeBindingExists.wait)
        """
