...
# dataGen = DataGenerator(indices_list[88:89], pp, training=False, validation=False, shuffle=False)
#
# from miscnn.utils.visualizer import visualize_sample
# import numpy as np
#
# result = []
# print("Length MIScnn DataGenerator:", len(dataGen))
# for batch in dataGen:
#     print("Batch:", batch.shape)
#     result.append(batch)
# print(len(result))
# print("Number of batches created by MIScnn DataGenerator:", len(result))
