...
# command = [f'{python_path} main.py -g -p -i', f'{python_path} main.py -ng -np -ni',
#            f'{python_path} main.py -ng -p -i', f'{python_path} main.py -ng -np -i',
#            f'{python_path} main.py -g -np -ni', f'{python_path} main.py -ng -p -ni',
#            f'{python_path} main.py -g -np -i', f'{python_path} main.py -g -p -ni'
#            ]
...
subprocess.run([python_path, 'src/main.py', 'testing', '-g', '-np', '-i'], check=True)
os.chdir('testing')
