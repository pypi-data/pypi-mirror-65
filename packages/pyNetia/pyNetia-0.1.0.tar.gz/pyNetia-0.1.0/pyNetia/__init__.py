...
SUPPORTED_APPS = ['hbogo', 'kinoplex', 'ninateka', 'ipla', 'abcvod', 'premiumplus', 'npvr', 'goon', 'netiatvshop',
                  'filmbox', 'tvnplayer', 'netiacloud', 'tubafm', 'tvnmeteo', 'tvpsport', 'pinkvision', 'erowizja',
                  'youtube'
                  ]
