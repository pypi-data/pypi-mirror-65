...
class SqsLauncher(object):
    ...
    def recive_messages(self, queue_url):
        message_dict = {}
        try:
            response = self._client.receive_message(QueueUrl=queue_url, AttributeNames=["All"])
    ...
    def delete_message(self, queue_url, reciptHandler):
        try:
