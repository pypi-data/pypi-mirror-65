...
from kuob.urllib_http_adapter import URLLibHttpAdapter
from kuob.http_adapter import HTTPConnectionError
...
class Api:
    ...
    def _user_agent(self):
        ...
        return 'kuob/%s %s/%s %s' % (__version__,
    ...
    def _handle_error(self, status, body):
        errors = {
            ...
            404: "API endpoint not found. This kuob version may no longer be supported. Please upgrade to the latest version.",
