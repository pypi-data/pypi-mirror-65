...
# import SpellCheck
from geodata import GeoUtil, Loc, Country, GeoSearch, Normalize, CachedDictionary, AlternateNames
...
class GeodataFiles:
    ...
    def open_geodb(self, repair_database:bool) -> bool:
        ...
        if os.path.exists(db_path):
            ...
            self.geodb = GeoSearch.GeoSearch(db_path=db_path,
    ...
    def create_geonames_database(self):
        ...
        self.geodb.create_main_indices()
    ...
    def _update_geo_row_name(geo_row, name):
        ...
        geo_row[GeoSearch.Entry.SDX] = GeoUtil.get_soundex(geo_row[GeoSearch.Entry.NAME])
    ...
    def insert_georow(self, geoname_row):
        ...
        if int(geoname_row.pop) > 1000000 and 'PP' in geoname_row.feat_code:
            geo_row[GeoSearch.Entry.FEAT] = 'PP1M'
        elif int(geoname_row.pop) > 100000 and 'PP' in geoname_row.feat_code:
            geo_row[GeoSearch.Entry.FEAT] = 'P1HK'
        elif int(geoname_row.pop) > 10000 and 'PP' in geoname_row.feat_code:
            geo_row[GeoSearch.Entry.FEAT] = 'P10K'

        self.geodb.insert(geo_tuple=geo_row, feat_code=geoname_row.feat_code)
        ...
        if geo_row[GeoSearch.Entry.ISO] == 'us' and geoname_row.feat_code == 'ADM1':
            ...
            self._update_geo_row_name(geo_row=geo_row, name=geo_row[GeoSearch.Entry.ADM1])
            self.geodb.insert(geo_tuple=geo_row, feat_code=geoname_row.feat_code)
