...
def signature_to_function(function_signature):
    ...
    if not 'Function-Signatures' in dir_list:
        import subprocess
        subprocess.run(['git', 'clone', 'https://github.com/yzstr/Function-Signatures.git', '../Function-Signatures'])
    
    import csv
    with open('../Function-Signatures/Function-Signature.csv','r') as f:
        reader = csv.reader(f)
