...
_FAMILY_AFI = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AFI_OPAQUE', index=4, number=16397,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_FAMILY_SAFI = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_MPLS_VPN', index=7, number=128,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_MPLS_VPN_MULTICAST', index=8, number=129,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_ROUTE_TARGET_CONSTRAINTS', index=9, number=132,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_FLOW_SPEC_UNICAST', index=10, number=133,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_FLOW_SPEC_VPN', index=11, number=134,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SAFI_KEY_VALUE', index=12, number=241,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
