...
BioSAK SILVA_for_BLCA -SILVA_db SILVA_138_SSURef_NR99_tax_silva.fasta
...
if __name__ == "__main__":
    ...
    parser.add_argument('-SILVA_db', required=True, help='SILVA_db file, e.g. SILVA_138_SSURef_NR99_tax_silva.fasta')
