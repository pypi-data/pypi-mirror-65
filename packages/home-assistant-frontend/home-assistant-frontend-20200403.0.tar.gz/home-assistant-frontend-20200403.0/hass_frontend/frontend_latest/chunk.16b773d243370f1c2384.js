...
`},297:function(e,t,a){"use strict";var r=a(4),s=a(32),i=(a(300),a(202),a(187)),n=a(108);customElements.define("state-info",class extends s.a{static get template(){return r.a`
    ...
    `}static get properties(){return{hass:Object,stateObj:Object,inDialog:{type:Boolean,value:()=>!1},rtl:{type:Boolean,reflectToAttribute:!0,computed:"computeRTL(hass)"}}}computeStateName(e){return Object(i.a)(e)}computeRTL(e){return Object(n.a)(e)}})},300:function(e,t,a){"use strict";var r=a(1),s=a(32),i=a(301),n=a(191);customElements.define("ha-relative-time",class extends(Object(n.a)(s.a)){static get properties(){return{hass:Object,datetime:{type:String,observer:"datetimeChanged"},datetimeObj:{type:Object,observer:"datetimeObjChanged"},parsedDateTime:Object}}constructor(){super(),this.updateRelative=this.updateRelative.bind(this)}connectedCallback(){super.connectedCallback(),this.updateInterval=setInterval(this.updateRelative,6e4)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.updateInterval)}datetimeChanged(e){this.parsedDateTime=e?new Date(e):null,this.updateRelative()}datetimeObjChanged(e){this.parsedDateTime=e,this.updateRelative()}updateRelative(){const e=Object(r.a)(this);this.parsedDateTime?e.innerHTML=Object(i.a)(this.parsedDateTime,this.localize):e.innerHTML=this.localize("ui.components.relative_time.never")}})},301:function(e,t,a){"use strict";a.d(t,"a",function(){return i});const r=[60,60,24,7],s=["second","minute","hour","day"];function i(e,t,a={}){let i=((a.compareTime||new Date).getTime()-e.getTime())/1e3;const n=i>=0?"past":"future";let o;i=Math.abs(i);for(let c=0;c<r.length;c++){if(i<r[c]){i=Math.floor(i),o=t(`ui.components.relative_time.duration.${s[c]}`,"count",i);break}i/=r[c]}return void 0===o&&(o=t("ui.components.relative_time.duration.week","count",i=Math.floor(i))),!1===a.includeTense?o:t(`ui.components.relative_time.${n}`,"time",o)}},570:function(e,t,a){"use strict";a.d(t,"b",function(){return s}),a.d(t,"a",function(){return i});var r=a(131);const s=e=>e.include_domains.length+e.include_entities.length+e.exclude_domains.length+e.exclude_entities.length===0,i=(e,t,a,s)=>{const i=new Set(e),n=new Set(t),o=new Set(a),c=new Set(s),l=i.size>0||n.size>0,d=o.size>0||c.size>0;return l||d?l&&!d?e=>n.has(e)||i.has(Object(r.a)(e)):!l&&d?e=>!c.has(e)&&!o.has(Object(r.a)(e)):i.size?e=>i.has(Object(r.a)(e))?!c.has(e):n.has(e):o.size?e=>o.has(Object(r.a)(e))?n.has(e):!c.has(e):e=>n.has(e):()=>!0}},571:function(e,t,a){"use strict";a.d(t,"a",function(){return i});var r=a(11);const s=()=>Promise.all([a.e(2),a.e(44)]).then(a.bind(null,782)),i=(e,t)=>{Object(r.a)(e,"show-dialog",{dialogTag:"dialog-domain-toggler",dialogImport:s,dialogParams:t})}}}]);
//# sourceMappingURL=chunk.16b773d243370f1c2384.js.map