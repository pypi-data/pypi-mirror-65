/*! For license information please see chunk.61abb7dfa96bba5ed8a2.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[15],{122:function(e,t,r){"use strict";r.d(t,"a",function(){return i});r(3);const i={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(e){return(this._clampValue(e)-this.min)/(this.max-this.min)},_clampValue:function(e){return Math.min(this.max,Math.max(this.min,this._calcStep(e)))},_calcStep:function(e){if(e=parseFloat(e),!this.step)return e;var t=Math.round((e-this.min)/this.step);return this.step<1?t/(1/this.step)+this.min:t*this.step+this.min},_validateValue:function(){var e=this._clampValue(this.value);return this.value=this.oldValue=isNaN(e)?this.oldValue:e,this.value!==e},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}}},145:function(e,t,r){"use strict";r(51),r(78),r(166),r(73);var i=r(33),a=r(63),s=r(122),n=r(61),o=r(5),l=r(39);const d=r(3).c`
  <style>
    :host {
      @apply --layout;
...
//# sourceMappingURL=chunk.61abb7dfa96bba5ed8a2.js.map