"""Основной модуль сервера, обрабатывающий пакеты"""
...
from system.metaclasses import ServerMaker
from system.descryptors import Port
from system.config import (
    ...
    PUBLIC_KEY,
    RESPONSE_205)
from system.utils import send_message, get_message
from system.decos import login_required
...
class MessageProcessor(Thread):
    ...
    def process_client_message(self, message, client):
        ...
        cообщение от клиента, проверяет корректность, отправляет
        cловарь-ответ в случае необходимости."""
    ...
    def service_update_lists(self):
        """Функция - отправляет сервисное сообщение 205
        с требованием клиентам обновить списки"""
