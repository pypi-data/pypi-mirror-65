...
class ServerStorage:
    ...
    def process_message(self, sender, recipient):
        """# Функция фиксирует передачу сообщения и
        делает соответствующие отметки в БД"""
    ...
    def login_history(self, username=None):
        """Функция возвращающаяя историю входов по пользователю или
        всем пользователям"""
