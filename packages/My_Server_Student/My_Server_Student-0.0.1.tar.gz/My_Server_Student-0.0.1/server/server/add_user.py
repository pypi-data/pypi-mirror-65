"""Модуль окна диалога регистрации пользователя на сервере."""
...
class RegisterUser(QDialog):
    """Класс окна диалога регистрации пользователя на сервере."""
    ...
    def save_data(self):
        """Функция проверки правильности ввода и
        ...
        if not self.client_name.text():
            ...
            passwd_hash = pbkdf2_hmac('sha512', passwd_bytes, salt, 10000)
