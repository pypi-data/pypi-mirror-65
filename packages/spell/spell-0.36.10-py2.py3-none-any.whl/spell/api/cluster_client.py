...
class ClusterClient(base_client.BaseClient):
    def get_cluster(self, cluster_name):
        ...
        """
        r = self.request(
            "get", url_path_join(CLUSTER_RESOURCE_URL, self.owner, cluster_name)
        )
    ...
    def validate_cluster_name(self, name):
        ...
        r = self.request(
            "get",
            url_path_join(CLUSTER_RESOURCE_URL, self.owner, "validate_name", name),
        )
        self.check_and_raise(r)
    ...
    def set_kube_config(self, cluster_name, kube_config):
        ...
        endpoint = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "kube_config"
        )
        r = self.request("put", endpoint, payload=payload)
        self.check_and_raise(r)
    ...
    def add_bucket(self, bucket_name, cluster_name, provider):
        ...
        endpoint = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "bucket"
        )
        r = self.request("put", endpoint, payload=payload)
        self.check_and_raise(r)
    ...
    def update_cluster_version(self, cluster_name, version):
        ...
        endpoint = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "update_version"
        )
        r = self.request("put", endpoint, payload=payload)
        self.check_and_raise(r)
    ...
    def delete_cluster_contents(self, cluster_name):
        ...
        """
        url = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "delete_contents"
        )
    ...
    def is_cluster_drained(self, cluster_name):
        ...
        """
        url = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "is_drained"
        )
    ...
    def create_machine_type(
        ...
        endpoint = url_path_join(
            CLUSTER_RESOURCE_URL, self.owner, cluster_name, "supply_config"
        )
