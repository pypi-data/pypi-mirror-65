...
class TestChkMethods(unittest.TestCase):
    ...
    def test_scrub_secret(self):
        ...
        secret = 'donotexpose'
        urls = [f"https://example.no/front/check_mk/view.py?_transid=-1&_do_actions=yes&_do_confirm=yes&output_format=json&_username=user-api&_secret={secret}&is_service_acknowledged=0&view_name=svcproblems"]
