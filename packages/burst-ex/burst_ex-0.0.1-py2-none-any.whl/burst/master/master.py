...
class Master(object):
    ...
    def run(self):
        ...
        _thread.start_new(self._connect_to_proxy, ())
    ...
    def _spawn_workers(self):
        ...
        for group_id, group_info in list(self.app.config['GROUP_CONFIG'].items()):
            proc_env = dict(
    ...
    def _monitor_child_processes(self):
        while 1:
            ...
            if self.proxy_process is None and not [x for x in self.worker_processes if x]:
                # 没活着的proxy和worker了
                break
