...
class SavingsMeterBillResponse(Model):
    ...
    :param batcc_cost: Baseline Adjusted to Curent Conditions (BATCC) Cost
    :type batcc_cost: float
    :param batcc_native_use: Baseline Adjusted to Curent Conditions (BATCC)
     Native Use
    :type batcc_native_use: float
    :param batcc_weather_native_use: Baseline Adjusted to Curent Conditions
     (BATCC) Weather Native Use
    :type batcc_weather_native_use: float
    :param batcc_nonweather_native_use: Baseline Adjusted to Curent Conditions
     (BATCC) Nonweather Native Use
    ...
    :param native_use_unit: Native use unit of measure
    :type native_use_unit: ~energycap.sdk.models.UnitChild
    :param review: Indicates whether or not the cost avoidance detail hs been
     reviewed
