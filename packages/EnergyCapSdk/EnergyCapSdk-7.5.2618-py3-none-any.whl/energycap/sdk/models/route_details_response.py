...
class RouteDetailsResponse(Model):
    ...
    :type meters: list[~energycap.sdk.models.MeterChildIncludePlace]
    ...
    _attribute_map = {
        'meters': {'key': 'meters', 'type': '[MeterChildIncludePlace]'},
    ...
    def __init__(self, meters=None, route_id=None, route_info=None, route_code=None, number_of_meters=None):
