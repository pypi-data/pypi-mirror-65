...
class SystemSettingsResponse(Model):
    ...
    :param default_topmost_place: Default topmost place for new users
    :type default_topmost_place: ~energycap.sdk.models.PlaceChild
    :param default_cost_center: Default topmost cost center for new users
    :type default_cost_center: ~energycap.sdk.models.CostCenterChild
    :param default_user_role: Default user role for new users
