...
class BillHeaderUpdate(Model):
    ...
    :param end_date:  <span class='property-internal'>Required</span>
    ...
    :param account_period:  <span class='property-internal'>Required</span>
    :type account_period:
     ~energycap.sdk.models.BillHeaderUpdateAccountPeriodChild
    :param billing_period:  <span class='property-internal'>Required</span>
    :type billing_period:
     ~energycap.sdk.models.BillHeaderUpdateBillingPeriodChild
    :param estimated:  <span class='property-internal'>Required</span>
