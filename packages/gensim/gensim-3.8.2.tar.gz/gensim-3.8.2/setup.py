...
#
# This handles additional commands for handling Gensim wheels during a release.
# The location of the wheels is specified in the setup.cfg file.
# Currently, this is the gensim-wheels S3 bucket.
#
# CI workers for the <https://github.com/MacPython/gensim-wheels> repo put them
# the wheels there once their respective builds are successful.
#
