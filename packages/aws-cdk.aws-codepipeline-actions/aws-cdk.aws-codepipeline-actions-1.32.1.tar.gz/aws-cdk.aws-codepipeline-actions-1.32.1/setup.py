...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_codepipeline_actions._jsii": [
            "aws-codepipeline-actions@1.32.1.jsii.tgz"
        ],
        "aws_cdk.aws_codepipeline_actions": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codebuild==1.32.1",
        "aws-cdk.aws-codecommit==1.32.1",
        "aws-cdk.aws-codedeploy==1.32.1",
        "aws-cdk.aws-codepipeline==1.32.1",
