...
class ExplorerApi(object):
    ...
    def remove(self, data_source_id, request_body, **kwargs):  # noqa: E501
        """Remove document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove(data_source_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.remove_with_http_info(data_source_id, request_body, **kwargs)  # noqa: E501

    def remove_with_http_info(self, data_source_id, request_body, **kwargs):  # noqa: E501
        """Remove document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_with_http_info(data_source_id, request_body, async_req=True)
        >>> result = thread.get()
    ...
    def rename(self, data_source_id, request_body, **kwargs):  # noqa: E501
        """Rename document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename(data_source_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.rename_with_http_info(data_source_id, request_body, **kwargs)  # noqa: E501

    def rename_with_http_info(self, data_source_id, request_body, **kwargs):  # noqa: E501
        """Rename document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rename_with_http_info(data_source_id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `rename`")  # noqa: E501
