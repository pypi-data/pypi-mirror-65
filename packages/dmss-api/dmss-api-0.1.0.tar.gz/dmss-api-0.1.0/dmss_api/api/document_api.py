...
class DocumentApi(object):
    ...
    def update(self, data_source_id, document_id, body, **kwargs):  # noqa: E501
        """Update document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(data_source_id, document_id, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(data_source_id, document_id, body, **kwargs)  # noqa: E501

    def update_with_http_info(self, data_source_id, document_id, body, **kwargs):  # noqa: E501
        """Update document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(data_source_id, document_id, body, async_req=True)
        >>> result = thread.get()
