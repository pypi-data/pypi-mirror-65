...
class RayvisionUpload(object):
    ...
    def __init__(self, api):
        ...
        db_dir = self._check_and_mk()
        self.check_tranfer_log_path()
        self.db_ini = os.path.join(db_dir, 'db_ini')
        self._db = os.path.join(db_dir, 'db')

    def check_tranfer_log_path(self):
        """Check the log location of the transport engine."""
        transfer_path = os.environ.get("RAYVISION_LOG")
    ...
    def _check_and_mk(self):
        ...
        db_path = os.environ.get("RAYVISION_DB")
        if not db_path:
            if self.api.user_info['local_os'] == "windows":
