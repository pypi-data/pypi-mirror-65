...
from ccalafiore.preprocessing.axes_to_variables_table import fast_balanced as cc_a2v
...
def from_2_arrays(
    ...
    if balance:
        ...
        if n_axes_other_array_input == 0:
            array_variables_adding_axes_object = array_variables_adding_axes
            conditions_variables_table_adding_axes_object = trials_to_conditions(
                array_variables_adding_axes_object, axis_combinations=axis_combinations_in_combinations)
        elif n_axes_other_array_input > 0:
            indexes_object = np.empty(2, dtype=object)
            indexes_object[axis_combinations_in_combinations] = slice(None)
            indexes_object[axis_variables_in_combinations] = slice(
                n_axes_other_array_input, n_axes_other_array_input + 2)
            indexes_not_object = np.copy(indexes_object)
            indexes_not_object[axis_variables_in_combinations] = slice(n_axes_other_array_input)

            array_variables_adding_axes = cc_a2v(
                array_variables_adding_axes,
                axes_removing_input=axes_other_array_input,
                axis_samples_input=axis_samples_input,
                axis_variables_table_input=axis_variables_table_input,
                variables_inserting_table_output=np.arange(n_axes_other_array_input),
                variables_staying_table_input=None,
                dtype=None)
            array_variables_adding_axes_object = array_variables_adding_axes[tuple(indexes_object)]
            array_variables_adding_axes_not_object = array_variables_adding_axes[tuple(indexes_not_object)]

            array_variables_staying = cc_a2v(
                array_variables_staying,
                axes_removing_input=axes_other_array_input,
                axis_samples_input=axis_samples_input,
                axis_variables_table_input=axis_variables_table_input,
                variables_inserting_table_output=np.arange(n_axes_other_array_input),
                variables_staying_table_input=None,
                dtype=None)[tuple(indexes)]

            conditions_variables_table_adding_axes_object = trials_to_conditions(
                array_variables_adding_axes_object, axis_combinations=axis_combinations_in_combinations)

            n_conditions_variables_table_adding_axes_not_object = shape_array_variables_adding_axes[
                axes_other_array_input]

            combinations_axes_inserting_not_object = n_conditions_to_combinations(
                n_conditions_variables_table_adding_axes_not_object)

        n_conditions_variables_table_adding_axes_object = conditions_to_n_conditions(
            conditions_variables_table_adding_axes_object)
        n_combinations_variables_table_adding_axes_object = int(np.prod(
            n_conditions_variables_table_adding_axes_object))

        combinations_variables_table_adding_axes_object = conditions_to_combinations(
            conditions_variables_table_adding_axes_object,
            axis_combinations=axis_combinations_in_combinations)
        ...
        # if n_axes_other_array_input == 0:
        for i in range(n_combinations_variables_table_adding_axes_object):
            indexes_output_object[axes_inserting] = combinations_axes_inserting_object[i]
            indexes_combinations[axis_combinations_in_combinations] = slice(i, i + 1)
            indexes_array_variables_staying[axis_samples_input] = np.all(
                array_variables_adding_axes_object ==
                combinations_variables_table_adding_axes_object[tuple(indexes_combinations)],
                axis=axis_variables_in_combinations)
        ...
        #     shape_array_output[axis_samples_input] = 0 # (
        #             # shape_array_variables_staying[axis_samples_input] / n_combinations_variables_table_adding_axes)
        #
        #     dtype = array_variables_staying.dtype
        ...
        #                 array_variables_staying_j[tuple(indexes_array_variables_staying_j)],
        #                 axis=axis_samples_input)
