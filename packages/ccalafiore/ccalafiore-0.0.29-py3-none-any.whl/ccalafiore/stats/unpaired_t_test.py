...
def scores_formatted_to_df_in_unpaired_t_test(
    ...
    n_samples = cc_stats_basics.scores_to_n_samples(scores_formatted, axis_samples, keepdims=keepdims)
    ...
    if equal_variances:
        ...
        variances = cc_stats_basics.scores_to_variances(scores_formatted, axis_samples, keepdims=keepdims)
...
def scores_formatted_to_unpaired_t_test(
    ...
    means_of_scores = cc_stats_basics.scores_to_means(scores_formatted, axis_samples, keepdims=keepdims)
    diff_of_means = cc_stats_basics.scores_to_diff_of_scores(means_of_scores, axis_comparisons, keepdims=keepdims)
