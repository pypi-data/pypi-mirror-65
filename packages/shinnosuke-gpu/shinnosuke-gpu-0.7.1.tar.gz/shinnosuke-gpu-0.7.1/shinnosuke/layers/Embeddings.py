...
class Embedding(Layer):
    def __init__(self, input_dim: int, output_dim: int, embeddings_initializer='uniform', mask_zero=False, input_length=None, **kwargs):
    ...
    def backward(self):
        ...
        if W.require_grads:
            W.grads[self.input_tensor] += self.grads
