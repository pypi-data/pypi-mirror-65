...
class ManualOnsetFrame(tk.Frame):
    ...
    def get_square_coord_around_cell(self, cell, x_len_max, y_len_max):
        ...
        if use_old_version:
            ...
            max_x_centroid = min_x_centroid + self.segment_window_in_pixels - 1
            min_y_centroid = centroid_cell[1] - int(self.segment_window_in_pixels // 2)
            max_y_centroid = min_y_centroid + self.segment_window_in_pixels - 1
            ...
            if ((maxx_cell - minx_cell + 1) >= self.segment_window_in_pixels) or \
                    ((maxy_cell - miny_cell + 1) >= self.segment_window_in_pixels):
                minx = min_x_centroid
                miny = min_y_centroid
                ...
                if (minx + self.segment_window_in_pixels - 1) < max_x_centroid:
                    minx = max_x_centroid - self.segment_window_in_pixels + 1
                if (minx + self.segment_window_in_pixels - 1) < maxx_cell:
                    minx = maxx_cell - self.segment_window_in_pixels + 1
                if (maxy + self.segment_window_in_pixels - 1) < max_y_centroid:
                    miny = max_y_centroid - self.segment_window_in_pixels + 1
                if (miny + self.segment_window_in_pixels - 1) < maxy_cell:
                    miny = maxy_cell - self.segment_window_in_pixels + 1
                ...
                maxx = minx + self.segment_window_in_pixels - 1
                maxy = miny + self.segment_window_in_pixels - 1
                len_x = self.segment_window_in_pixels
                len_y = self.segment_window_in_pixels
        else:
            centroid_cell = self.data_and_param.coord_obj.center_coord[cell]
            min_x_centroid = centroid_cell[0] - int(self.segment_window_in_pixels // 2)
            min_y_centroid = centroid_cell[1] - int(self.segment_window_in_pixels // 2)
