...
def search_component_definitions_simplified(
    ...
    url = "{}/assets/v2/component/definition".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeField=timeField, definition=definition, domain=domain, type=type, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
