...
def search_asset_groups(
    ...
    :param str ancestor: Search for AssetGroups descending from this ancestor AssetGroup ID or short name 
    :param list child: Search for AssetGroups with these children IDs or short names 
    ...
    :param list criticalitySearchRequest: Search by Asset Groups by Confidentiality, Availability, and Integrity.All criteria values must match for an Asset Group to match. Use subcriteria for OR query behaviour. 
