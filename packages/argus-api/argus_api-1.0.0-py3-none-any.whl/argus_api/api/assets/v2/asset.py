...
def list_assets(
    ...
    url = "{}/assets/v2/asset".format(settings["api"]["api_url"], limit=limit, customer=customer, asset=asset, parent=parent, keywords=keywords, offset=offset, includeDeleted=includeDeleted, startTimestamp=startTimestamp, endTimestamp=endTimestamp, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_assets(
    ...
    :param str ancestor: Search for Assets descending from this ancestor AssetGroup ID or short name 
    :param list assetComponentSearchRequest: Search for Assets by their components using AND search mode i.e. all criteria must match.If you want different behaviour try using subcriteria 
