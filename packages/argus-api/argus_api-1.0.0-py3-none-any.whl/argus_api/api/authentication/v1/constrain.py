...
def constrain(
    ...
    :param list customerID: DEPRECATED Set of customers the session should be valid for (default is all current customers). Cannot extend the current set of customers.
    :param list functionID: DEPRECATED Set of functions/roles (by ID) the session should be granted (default is all current functions). Cannot extend the current set of functions.
