...
def constrain_1(
    ...
    :param list customerID: DEPRECATED Set of customers the session should be valid for. If not specified, customers will be inherited from active permissions.
