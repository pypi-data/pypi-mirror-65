...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of truelayer.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the truelayer.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = truelayer.Configuration(
        signing_info = truelayer.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.truelayer.com/data/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("truelayer")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 0.0.1.dev0+g9e8f8bb.d20200407".\
