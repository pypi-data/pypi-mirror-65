...
def test_uuid_generator(testbench_name=None, start_datetime=None, dut_record=None):
    ...
    if not datetime_format:
        ...
        value =  f"{testbench_name}.{datetime_format}"
...
class TestIDRecord(BaseDataClass):
    ...
    def __post_init__(self):
        if self.test_uuid is None:
            self.test_uuid = test_uuid_generator(self.testbench_name, self.start_datetime, self.dut)
    ...
    def create(cls, testbench_name, dut, start_datetime, tags=None):
        ...
        return cls(
            ...
            dut=dut_record,
            test_uuid=None, # will be generated in post init
...
class DutOp(BaseDataClass):
    ...
    op_datetime: datetime = datetime.utcnow
