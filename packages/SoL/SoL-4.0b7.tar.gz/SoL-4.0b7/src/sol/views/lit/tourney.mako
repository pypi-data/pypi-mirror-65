  ...
  <thead>
    <tr>
      ...
      % if entity.championship.trainingboards:
        <th colspan="3" class="center aligned scores-header">${_('Average errors')}</th>
      % endif
  ...
  <tr>
    ...
    % if entity.championship.trainingboards:
      <td class="right aligned">
        ${format_decimal(row.misses1 / entity.championship.trainingboards, '#.00') if row.misses1 else '—'}
      </td>
      <td class="separator"></td>
      <td class="right aligned">
        ${format_decimal(row.misses2 / entity.championship.trainingboards, '#.00') if row.misses2 else '—'}
      </td>
    % endif
    <% scored = entity.championship.trainingboards and row.misses1 and row.misses2 or (
        not entity.championship.trainingboards and (row.score1 != 0 or row.score2 != 0)) %>
