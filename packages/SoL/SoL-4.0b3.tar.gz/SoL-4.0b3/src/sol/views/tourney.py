...
@expose(
    Match,
    fields=('board,description,score1,score2,misses1,misses2,turn,final'
    ...
    metadata=dict(
        ...
        misses1=dict(hidden=True, sortable=False, width=70),
        misses2=dict(hidden=True, sortable=False, width=70),
...
def newTurn(request):
    ...
    try:
        ...
        if tourney.championship.trainingboards:
