...
class AssetToolsCompleteAssetRepresentation(object):
    ...
    def __init__(self, asset_representation=None, components=None,
        ...
        self.fieldtypes = {
            ...
            "functional_location_representation": "AssetToolsFunctionalLocationRepresentation"
        }
        ...
        self._functional_location_representation = functional_location_representation
