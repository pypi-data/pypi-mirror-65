"""
   ...
   64、setleft：设置角色或项目编号的最左x坐标。
   65、setright：设置角色或项目编号的最右x坐标。
   66、settop：设置角色或项目编号的最上y坐标。
   67、setbottom：设置角色或项目编号的最下y坐标。
...
class Sprite(Turtle):
    ...
    def setleft(self,value,item=None):
      """设置角色或项目的最左x坐标
         value：浮点数据
         item：项目编号，整数。
      """
    ...
    def setright(self,value,item=None):
      """设置角色或项目的最右x坐标
         value：浮点数据
         item：项目编号，整数。
      """
    ...
    def setbottom(self,value,item=None):
      """设置角色或项目的最下y坐标
         value：浮点数据
         item：项目编号，整数。
      """
    ...
    def settop(self,value,item=None):
      """设置角色或项目的最上y坐标
         value：浮点数据
         item：项目编号，整数。
      """
