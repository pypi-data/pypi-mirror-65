...
import sympathy.app.library_creator
...
class DeleteParentPortCommandBase(UndoCommandBase,
                                  CreateElementCommandInterface):
...
class DeleteParentInputPortCommand(DeleteParentPortCommandBase):
    def __init__(self, port, parent=None):
...
class DeleteParentOutputPortCommand(DeleteParentPortCommandBase):
    def __init__(self, port, parent=None):
        flowio = port.mirror_port.node
...
class EditSubflowSettingsCommand(UndoCommandBase):
    ...
    def redo(self):
        ...
        if not overrides and settings['deprecated_warning']:
            self._subflow.app_core.create_node_result(
                self._subflow.full_uuid,
    ...
    def redo(self):
        ...
        if self._first_run:
            try:
                ...
                flow_data = sympathy.app.library_creator.get_flow_data(filename)
