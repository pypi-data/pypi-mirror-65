...
class PlanSettingsAssumptions(object):
    ...
    def __init__(self, traffic_jams=True, flight_distance=False, disable_compatibility=False, disable_capacity=False, same_order_time_window=False, expand_shift_time_window=False):  # noqa: E501
        """PlanSettingsAssumptions - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PlanSettingsAssumptions, dict):
