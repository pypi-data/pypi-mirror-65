...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.4.0-alpha.1585916266+g9a45d644'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.4.0-alpha.1585916266+g9a45d644`
                """)
            else:
                raise
