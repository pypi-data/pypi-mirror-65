...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.6.0-alpha.1586873789+ge9e3cd90'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.6.0-alpha.1586873789+ge9e3cd90`
                """)
            else:
                raise
