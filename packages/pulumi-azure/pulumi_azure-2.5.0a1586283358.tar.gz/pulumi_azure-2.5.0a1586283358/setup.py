...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.5.0-alpha.1586283358+g2284d09d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.5.0-alpha.1586283358+g2284d09d`
                """)
            else:
                raise
