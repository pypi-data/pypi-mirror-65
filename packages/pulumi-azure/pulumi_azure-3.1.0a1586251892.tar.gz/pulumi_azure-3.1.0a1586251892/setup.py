...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.1.0-alpha.1586251892+g61a25a08'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.1.0-alpha.1586251892+g61a25a08`
                """)
            else:
                raise
