...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.5.0-alpha.1586239871+g8b50bb1f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.5.0-alpha.1586239871+g8b50bb1f`
                """)
            else:
                raise
