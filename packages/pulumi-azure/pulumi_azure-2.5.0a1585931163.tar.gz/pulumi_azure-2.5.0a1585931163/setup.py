...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.5.0-alpha.1585931163+gb49e4c8d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.5.0-alpha.1585931163+gb49e4c8d`
                """)
            else:
                raise
