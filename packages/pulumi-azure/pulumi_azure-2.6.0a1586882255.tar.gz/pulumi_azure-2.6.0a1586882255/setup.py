...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v2.6.0-alpha.1586882255+gaffd9eaa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v2.6.0-alpha.1586882255+gaffd9eaa`
                """)
            else:
                raise
