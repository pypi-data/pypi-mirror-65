...
class OmaSpConnectorSettings(ConnectorSettings):
	...
	def __init__(A,client_id=_A,client_secret=_A,ocp_apim_subscription_key=_A):'OmaSpConnectorSettings - a model defined in Swagger';A._client_id=_A;A._client_secret=_A;A._ocp_apim_subscription_key=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.ocp_apim_subscription_key=ocp_apim_subscription_key
	@property
