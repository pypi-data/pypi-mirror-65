...
class SignetBankConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_D,_B:_D};attribute_map={_C:'xApiKey',_B:_B}
	def __init__(A,x_api_key=_A,country=_A):'SignetBankConnectorSettings - a model defined in Swagger';A._x_api_key=_A;A._country=_A;A.discriminator=_A;A.x_api_key=x_api_key;A.country=country
	@property
	def x_api_key(self):'Gets the x_api_key of this SignetBankConnectorSettings.  # noqa: E501\n\n        API client key (obtained at Open Banking Market)  # noqa: E501\n\n        :return: The x_api_key of this SignetBankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._x_api_key
	@x_api_key.setter
	def x_api_key(self,x_api_key):
		'Sets the x_api_key of this SignetBankConnectorSettings.\n\n        API client key (obtained at Open Banking Market)  # noqa: E501\n\n        :param x_api_key: The x_api_key of this SignetBankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=x_api_key
		if A is _A:raise ValueError('Invalid value for `x_api_key`, must not be `None`')
		self._x_api_key=A
	@property
	def country(self):'Gets the country of this SignetBankConnectorSettings.  # noqa: E501\n\n        Bank`s country  # noqa: E501\n\n        :return: The country of this SignetBankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._country
	@country.setter
	def country(self,country):
		'Sets the country of this SignetBankConnectorSettings.\n\n        Bank`s country  # noqa: E501\n\n        :param country: The country of this SignetBankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=country
	...
	def to_dict(D):
		...
		if issubclass(SignetBankConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,SignetBankConnectorSettings):return False
