...
DEFAULT_SCHEMA = (
    ...
    # Reserved for internal use, stores the frodocs.yml config file.
    ...
    # The Frodocs theme for the documentation.
    ('theme', config_options.Theme(default='frodocs')),
    ...
    # this should look like, ['UA-27795084-5', 'frodocs.org']
    ...
    # enabling strict mode causes Frodocs to stop the build when a problem is
    ...
    # Frodocs itself. A good example here would be including the current
    # project version.
