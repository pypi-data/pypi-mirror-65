...
from frodocs import utils
from frodocs.utils import filters
from frodocs.config.base import ValidationError
...
class Theme:
    ...
    def __init__(self, name=None, **user_config):
        ...
        # Frodocs provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        frodocs_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(frodocs_templates))
        ...
        # Include templates provided directly by Frodocs (outside any theme)
        self.dirs.append(frodocs_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'frodocs_theme.yml')
