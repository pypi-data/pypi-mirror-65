...
log = logging.getLogger('frodocs.config')
...
class Config(UserDict):
    ...
    def load_file(self, config_file):
        try:
            ...
            # Frodocs knows and understands ConfigurationErrors
            raise exceptions.ConfigurationError(
                "Frodocs encountered as error parsing the configuration file: {}".format(e)
            )
...
def _open_config_file(config_file):
    ...
    if config_file is None:
        config_file = os.path.abspath('frodocs.yml')
...
def load_config(config_file=None, **kwargs):
    ...
    the default `frodocs.yml` filename will loaded.
