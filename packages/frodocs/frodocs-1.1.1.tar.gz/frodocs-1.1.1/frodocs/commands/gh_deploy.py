...
default_message = """Deployed {sha} with Frodocs version: {version}"""
...
def gh_deploy(config, message=None, force=False, ignore_version=False):
    ...
    message = message.format(version=frodocs.__version__, sha=sha)
