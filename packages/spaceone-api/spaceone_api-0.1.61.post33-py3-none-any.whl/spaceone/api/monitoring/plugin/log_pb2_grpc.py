...
class LogStub(object):
  ...
  def __init__(self, channel):
    ...
    self.list = channel.unary_stream(
        ...
        response_deserializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_log__pb2.PluginResponse.FromString,
        )
...
def add_LogServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'list': grpc.unary_stream_rpc_method_handler(
          ...
          response_serializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_log__pb2.PluginResponse.SerializeToString,
      ),
  }
