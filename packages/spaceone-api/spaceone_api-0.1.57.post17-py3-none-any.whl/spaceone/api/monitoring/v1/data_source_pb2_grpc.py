...
class DataSourceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.verify_plugin = channel.unary_unary(
        ...
        request_serializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_data__source__pb2.VerifyPluginRequest.SerializeToString,
...
def add_DataSourceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'verify_plugin': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=spaceone_dot_api_dot_monitoring_dot_v1_dot_data__source__pb2.VerifyPluginRequest.FromString,
