...
_METRICINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chart_option', full_name='spaceone.api.monitoring.plugin.MetricInfo.chart_option', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLUGINMETRICSRESPONSE.fields_by_name['actions'].message_type = _PLUGINACTION
_PLUGINMETRICSRESPONSE.fields_by_name['result'].message_type = _METRICSINFO
_PLUGINMETRICDATARESPONSE.fields_by_name['actions'].message_type = _PLUGINACTION
