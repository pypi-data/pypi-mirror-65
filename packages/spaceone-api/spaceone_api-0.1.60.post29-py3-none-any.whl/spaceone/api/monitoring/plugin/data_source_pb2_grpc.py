...
class DataSourceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.verify = channel.unary_stream(
        ...
        response_deserializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_data__source__pb2.PluginResponse.FromString,
        )
...
def add_DataSourceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'verify': grpc.unary_stream_rpc_method_handler(
          ...
          response_serializer=spaceone_dot_api_dot_monitoring_dot_plugin_dot_data__source__pb2.PluginResponse.SerializeToString,
      ),
  }
