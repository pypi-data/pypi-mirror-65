...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v1.11.0-alpha.1586545140+g263a95b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v1.11.0-alpha.1586545140+g263a95b`
                """)
            else:
                raise
