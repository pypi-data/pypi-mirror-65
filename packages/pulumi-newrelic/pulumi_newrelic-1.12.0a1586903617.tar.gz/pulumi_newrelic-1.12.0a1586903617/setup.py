...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v1.12.0-alpha.1586903617+ge769bfe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v1.12.0-alpha.1586903617+ge769bfe`
                """)
            else:
                raise
