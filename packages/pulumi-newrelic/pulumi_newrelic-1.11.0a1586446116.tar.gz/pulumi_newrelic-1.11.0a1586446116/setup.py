...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v1.11.0-alpha.1586446116+ga7efaa2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v1.11.0-alpha.1586446116+ga7efaa2`
                """)
            else:
                raise
