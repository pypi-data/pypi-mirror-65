...
from frododocs.commands.build import build
from frododocs.config import load_config
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the FrodoDocs development server
    ...
    # string is returned. And it makes FrodoDocs temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='frododocs_')
