...
DEFAULT_SCHEMA = (
    ...
    # Reserved for internal use, stores the frododocs.yml config file.
    ...
    # The FrodoDocs theme for the documentation.
    ('theme', config_options.Theme(default='frododocs')),
    ...
    # this should look like, ['UA-27795084-5', 'frododocs.org']
    ...
    # enabling strict mode causes FrodoDocs to stop the build when a problem is
    ...
    # FrodoDocs itself. A good example here would be including the current
    # project version.
