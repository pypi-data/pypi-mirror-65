...
from frododocs.utils import filters
from frododocs.config.base import ValidationError
...
class Theme(object):
    ...
    def __init__(self, name=None, **user_config):
        ...
        # FrodoDocs provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        frododocs_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(frododocs_templates))
        ...
        # Include templates provided directly by Frodo Docs (outside any theme)
        self.dirs.append(frododocs_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'frododocs_theme.yml')
