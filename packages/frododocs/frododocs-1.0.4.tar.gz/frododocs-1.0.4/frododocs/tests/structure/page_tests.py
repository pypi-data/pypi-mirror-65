...
from frododocs.tests.base import load_config, dedent, LogTestCase
...
class PageTests(unittest.TestCase):
    ...
    def test_predefined_page_title(self):
        ...
        self.assertFalse(pg.is_section)
        self.assertTrue(pg.is_top_level)
        self.assertTrue(pg.markdown.startswith('# Bienvenido a Frodo Docs\n'))
        self.assertEqual(pg.meta, {})
        self.assertEqual(pg.next_page, None)
        self.assertEqual(pg.parent, None)
        self.assertEqual(pg.previous_page, None)
    ...
    def test_page_title_from_markdown(self):
        ...
        self.assertEqual(pg.parent, None)
        self.assertEqual(pg.previous_page, None)
        self.assertEqual(pg.title, 'Bienvenido a Frodo Docs')
        self.assertEqual(pg.toc, [])
    ...
    def test_BOM(self):
        ...
        with TemporaryDirectory() as docs_dir:
            # We don't use frododocs.tests.base.tempdir decorator here due to uniqueness of this test.
    ...
    def test_page_edit_url(self):
        configs = [
            {
                'repo_url': 'http://github.com/frododocs/frododocs'
            },
            {
                'repo_url': 'https://github.com/frododocs/frododocs/'
            }, {
        ...
        expected = [
            'http://github.com/frododocs/frododocs/edit/master/docs/testing.md',
            'https://github.com/frododocs/frododocs/edit/master/docs/testing.md',
            None,
    ...
    def test_nested_page_edit_url(self):
        ...
        expected = [
            'http://github.com/frododocs/frododocs/edit/master/docs/sub1/non-index.md',
            'https://github.com/frododocs/frododocs/edit/master/docs/sub1/non-index.md',
            None,
    ...
    def test_page_render(self):
        ...
        self.assertTrue(pg.content.startswith(
            '<h1 id="welcome-to-frododocs">Bienvenido a Frodo Docs</h1>\n'
        ))
        self.assertEqual(str(pg.toc).strip(), dedent("""
            Bienvenido a FrodoDocs - #bienvenido-a-frododocs
                Commands - #commands
...
class RelativePathExtensionTests(LogTestCase):
    ...
    def test_bad_relative_html_link(self):
        ...
        self.assertEqual(
            cm.output,
            ["WARNING:frododocs.structure.pages:Documentation file 'index.md' contains a link "
