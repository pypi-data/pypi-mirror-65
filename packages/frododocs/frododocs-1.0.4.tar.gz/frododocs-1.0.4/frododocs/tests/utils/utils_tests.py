...
from frododocs import utils, exceptions
from frododocs.structure.files import File
from frododocs.structure.pages import Page
from frododocs.tests.base import dedent, load_config
...
class UtilsTests(unittest.TestCase):
    ...
    def test_get_theme_dir(self, mock_iter):
        ...
        theme = mock.Mock()
        theme.name = 'frododocs2'
        theme.dist.key = 'frododocs2'
    ...
    def test_get_themes_warning(self, mock_iter):
        ...
        theme1 = mock.Mock()
        theme1.name = 'frododocs2'
        theme1.dist.key = 'frododocs2'
        theme1.load().__file__ = "some/path1"

        theme2 = mock.Mock()
        theme2.name = 'frododocs2'
        theme2.dist.key = 'frododocs3'
    ...
    def test_get_themes_error(self, mock_get, mock_iter):
        ...
        theme1 = mock.Mock()
        theme1.name = 'frododocs'
        theme1.dist.key = 'frododocs'
        theme1.load().__file__ = "some/path1"

        theme2 = mock.Mock()
        theme2.name = 'frododocs'
        theme2.dist.key = 'frododocs2'
        theme2.load().__file__ = "some/path2"

        mock_iter.return_value = iter([theme1, theme2])
        mock_get.return_value = {'frododocs': theme1, }
