    ...
    def get_model_class(cls, flavor: dict) -> type:
        ...
        if flavor_name == ModelSpecConstants.CUSTOM_MODEL_FLAVOR_NAME:
            try:
                ...
                raise ModelSpecValueError(f"{module_path} doesn't have attribute {class_name}")
        else:
            try:
            ...
            try:
                ...
                raise ModelSpecValueError(
                    f"Failed to load builtin module {module_path}, please make sure you have the right value of "
