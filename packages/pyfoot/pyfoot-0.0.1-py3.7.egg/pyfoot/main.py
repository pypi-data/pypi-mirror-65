...
class Text(Actor):
    ...
    def __init__(self, message: str, fontsize: int = 15, font: str = "Arial", color: AnyColor = Color(0, 0, 0), bg: AnyColor = None, editable: bool = False):
        super().__init__()
        ...
        self.image.surface = self.textbox.surface
