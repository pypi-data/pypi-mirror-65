...
class Store():
    ...
    def _create_next_run_directory(self, ws_name, is_parent):
        ...
        # remove legacy control file
        # if initial_next > 1:
        #     self.helper.remove_legacy_run_control_file(ws_name)

        return self.helper.create_next_run_by_name(ws_name, run_name)

    def _create_next_child_directory(self, ws_name, parent_name):
        ...
        child_run_name = "{}.{}".format(parent_name, child_id)
        console.print("child_run_name=" + str(child_run_name))

        return self.helper.create_next_run_by_name(ws_name, child_run_name)

    # def old_create_next_run_directory(self, ws_name, is_parent):
    #     '''
    ...
    # def old_create_next_child_directory(self, ws_name, parent_run_name):
    #     '''
    #     Using the helper's "create_next_run_core" to create a unique, 
    ...
    def wrapup_run(self, ws_name, run_name, aggregate_dest, dest_name, status, exit_code, primary_metric, maximize_metric, 
        ...
        console.print("wrapup: run_index={}".format(run_index))
        if run_index is not None:
            console.print("wrapup: calling mark_node_run_index_complete")
    ...
    # def old_create_next_job_file(self):
    #     '''
