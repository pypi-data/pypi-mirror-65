...
class BackendBase(implements(BackendInterface)):
    ...
    def add_first_cmds(self, cmds, script_name):
    ...
    def wrap_user_command(self, user_parts, snapshot_dir, store_data_dir, data_action, data_writable, \
        ...
        setup=None, post_setup_cmds=None, run_name=None, args=None):
        ...
        self.add_first_cmds(cmds, script_name)
        ...
        if not self.is_windows:
            ...
            self.emit_mount_cmds(cmds, storage_name, storage_key, container=workspace, store_path=store_path, 
                ...
                sudo_available=sudo_available, use_username=use_username, use_allow_other=False, env_var_name="XT_OUTPUT_DIR", 
