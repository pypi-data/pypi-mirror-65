...
class Philly(BackendBase):
    ...
    def process_data_action(self, cmds, store_data_dir, data_action):
        if data_action == "mount":
            ...
            self.append(cmds, 'export XT_DATA_MNT="{}/{}"'.format(data_mnt, store_data_dir))
            self.append(cmds, 'export XT_DATA_DIR="{}/{}"'.format(data_mnt, store_data_dir))
    ...
    def process_model_action(self, cmds, store_model_dir, model_action):
        if model_action == "mount":
            ...
            self.append(cmds, 'export XT_MODEL_MNT="{}/{}"'.format(model_mnt, store_model_dir))
            self.append(cmds, 'export XT_MODEL_DIR="{}/{}"'.format(model_mnt, store_model_dir))
    ...
    def wrap_cmd_line_for_philly_job(self, user_cmd, store_before_dir, store_output_dir, store_after_dir, 
        ...
        self.add_first_cmds(cmds, "long philly cmd string")
