...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipDrvOccupancyMaxActiveBlocksPerMultiprocessor = 8,
  HIP_API_ID_hipSetDevice = 9,
  HIP_API_ID_hipCtxGetApiVersion = 10,
  HIP_API_ID_hipSetupArgument = 11,
  HIP_API_ID_hipMemcpyFromSymbolAsync = 12,
  HIP_API_ID_hipExtGetLinkTypeAndHopCount = 13,
  HIP_API_ID_hipMemcpyDtoD = 14,
  HIP_API_ID_hipHostFree = 15,
  HIP_API_ID_hipMemcpy2DToArray = 16,
  HIP_API_ID_hipMemsetD8Async = 17,
  HIP_API_ID_hipCtxGetCacheConfig = 18,
  HIP_API_ID_hipStreamWaitEvent = 19,
  HIP_API_ID_hipDeviceGetStreamPriorityRange = 20,
  HIP_API_ID_hipModuleLoad = 21,
  HIP_API_ID_hipDevicePrimaryCtxSetFlags = 22,
  HIP_API_ID_hipLaunchCooperativeKernel = 23,
  HIP_API_ID_hipLaunchCooperativeKernelMultiDevice = 24,
  HIP_API_ID_hipMemcpyAsync = 25,
  HIP_API_ID_hipMalloc3DArray = 26,
  HIP_API_ID_hipStreamCreate = 27,
  HIP_API_ID_hipCtxGetCurrent = 28,
  HIP_API_ID_hipDevicePrimaryCtxGetState = 29,
  HIP_API_ID_hipEventQuery = 30,
  HIP_API_ID_hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 31,
  ...
  HIP_API_ID_hipMemPtrGetInfo = 39,
  HIP_API_ID_hipFuncGetAttribute = 40,
  HIP_API_ID_hipCtxGetFlags = 41,
  HIP_API_ID_hipStreamDestroy = 42,
  HIP_API_ID___hipPushCallConfiguration = 43,
  HIP_API_ID_hipMemset3DAsync = 44,
  HIP_API_ID_hipMemcpy3D = 45,
  HIP_API_ID_hipInit = 46,
  HIP_API_ID_hipMemcpyAtoH = 47,
  HIP_API_ID_hipStreamGetPriority = 48,
  HIP_API_ID_hipMemset2D = 49,
  HIP_API_ID_hipMemset2DAsync = 50,
  HIP_API_ID_hipDeviceCanAccessPeer = 51,
  HIP_API_ID_hipDeviceEnablePeerAccess = 52,
  HIP_API_ID_hipLaunchKernel = 53,
  HIP_API_ID_hipMemsetD16Async = 54,
  HIP_API_ID_hipModuleUnload = 55,
  HIP_API_ID_hipHostUnregister = 56,
  HIP_API_ID_hipProfilerStop = 57,
  HIP_API_ID_hipLaunchByPtr = 58,
  HIP_API_ID_hipStreamSynchronize = 59,
  HIP_API_ID_hipDeviceSetCacheConfig = 60,
  HIP_API_ID_hipGetErrorName = 61,
  HIP_API_ID_hipMemcpyHtoD = 62,
  HIP_API_ID_hipModuleGetGlobal = 63,
  HIP_API_ID_hipMemcpyHtoA = 64,
  HIP_API_ID_hipCtxCreate = 65,
  HIP_API_ID_hipMemcpy2D = 66,
  HIP_API_ID_hipIpcCloseMemHandle = 67,
  HIP_API_ID_hipChooseDevice = 68,
  HIP_API_ID_hipGetLastError = 69,
  HIP_API_ID_hipDeviceComputeCapability = 70,
  HIP_API_ID_hipDeviceGet = 71,
  HIP_API_ID_hipProfilerStart = 72,
  HIP_API_ID_hipCtxSetCacheConfig = 73,
  HIP_API_ID_hipFuncSetCacheConfig = 74,
  HIP_API_ID_hipModuleGetTexRef = 75,
  HIP_API_ID_hipMemcpyPeerAsync = 76,
  HIP_API_ID_hipMemcpyWithStream = 77,
  HIP_API_ID_hipDevicePrimaryCtxReset = 78,
  HIP_API_ID_hipMemcpy3DAsync = 79,
  HIP_API_ID_hipEventDestroy = 80,
  HIP_API_ID_hipCtxPopCurrent = 81,
  HIP_API_ID_hipGetSymbolAddress = 82,
  HIP_API_ID_hipHostGetFlags = 83,
  HIP_API_ID_hipHostMalloc = 84,
  HIP_API_ID_hipDriverGetVersion = 85,
  HIP_API_ID_hipMemGetInfo = 86,
  HIP_API_ID_hipDeviceReset = 87,
  HIP_API_ID_hipMemset = 88,
  HIP_API_ID_hipMemsetD8 = 89,
  HIP_API_ID_hipMemcpyParam2DAsync = 90,
  HIP_API_ID_hipHostRegister = 91,
  HIP_API_ID_hipCtxSetSharedMemConfig = 92,
  HIP_API_ID_hipArray3DCreate = 93,
  HIP_API_ID_hipIpcOpenMemHandle = 94,
  HIP_API_ID_hipDeviceSetSharedMemConfig = 95,
  HIP_API_ID_hipCtxDestroy = 96,
  HIP_API_ID_hipDeviceGetSharedMemConfig = 97,
  HIP_API_ID_hipMemcpy2DFromArray = 98,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags = 99,
  HIP_API_ID_hipSetDeviceFlags = 100,
  HIP_API_ID_hipHccModuleLaunchKernel = 101,
  HIP_API_ID_hipFree = 102,
  HIP_API_ID_hipOccupancyMaxPotentialBlockSize = 103,
  HIP_API_ID_hipDeviceGetAttribute = 104,
  HIP_API_ID_hipMemcpyDtoH = 105,
  HIP_API_ID_hipCtxDisablePeerAccess = 106,
  HIP_API_ID_hipMallocManaged = 107,
  HIP_API_ID_hipDeviceGetByPCIBusId = 108,
  HIP_API_ID_hipIpcGetMemHandle = 109,
  HIP_API_ID_hipMemcpyHtoDAsync = 110,
  HIP_API_ID_hipCtxGetDevice = 111,
  HIP_API_ID_hipMemset3D = 112,
  HIP_API_ID_hipModuleLoadData = 113,
  HIP_API_ID_hipDeviceTotalMem = 114,
  HIP_API_ID_hipOccupancyMaxActiveBlocksPerMultiprocessor = 115,
  HIP_API_ID_hipCtxSetCurrent = 116,
  HIP_API_ID_hipGetErrorString = 117,
  HIP_API_ID_hipDevicePrimaryCtxRetain = 118,
  HIP_API_ID_hipDeviceDisablePeerAccess = 119,
  HIP_API_ID_hipStreamCreateWithFlags = 120,
  HIP_API_ID_hipMemcpyFromArray = 121,
  HIP_API_ID_hipMemcpy2DAsync = 122,
  HIP_API_ID_hipFuncGetAttributes = 123,
  HIP_API_ID_hipGetSymbolSize = 124,
  HIP_API_ID_hipEventCreateWithFlags = 125,
  HIP_API_ID_hipStreamQuery = 126,
  HIP_API_ID_hipDeviceGetPCIBusId = 127,
  HIP_API_ID_hipMemcpy = 128,
  HIP_API_ID_hipPeekAtLastError = 129,
  HIP_API_ID_hipExtLaunchMultiKernelMultiDevice = 130,
  HIP_API_ID_hipStreamAddCallback = 131,
  HIP_API_ID_hipMemcpyToArray = 132,
  HIP_API_ID_hipMemsetD32 = 133,
  HIP_API_ID_hipExtModuleLaunchKernel = 134,
  HIP_API_ID_hipDeviceSynchronize = 135,
  HIP_API_ID_hipDeviceGetCacheConfig = 136,
  HIP_API_ID_hipMalloc3D = 137,
  HIP_API_ID_hipPointerGetAttributes = 138,
  HIP_API_ID_hipMemsetAsync = 139,
  HIP_API_ID_hipMemcpyToSymbol = 140,
  HIP_API_ID_hipCtxPushCurrent = 141,
  HIP_API_ID_hipMemcpyPeer = 142,
  HIP_API_ID_hipEventSynchronize = 143,
  HIP_API_ID_hipMemcpyDtoDAsync = 144,
  HIP_API_ID_hipExtMallocWithFlags = 145,
  HIP_API_ID_hipCtxEnablePeerAccess = 146,
  HIP_API_ID_hipMemcpyDtoHAsync = 147,
  HIP_API_ID_hipModuleLaunchKernel = 148,
  HIP_API_ID_hipMemAllocPitch = 149,
  HIP_API_ID_hipMemcpy2DFromArrayAsync = 150,
  HIP_API_ID_hipDeviceGetLimit = 151,
  HIP_API_ID_hipModuleLoadDataEx = 152,
  HIP_API_ID_hipRuntimeGetVersion = 153,
  HIP_API_ID___hipPopCallConfiguration = 154,
  HIP_API_ID_hipGetDeviceProperties = 155,
  HIP_API_ID_hipFreeArray = 156,
  HIP_API_ID_hipEventElapsedTime = 157,
  HIP_API_ID_hipDevicePrimaryCtxRelease = 158,
  HIP_API_ID_hipHostGetDevicePointer = 159,
  HIP_API_ID_hipMemcpyParam2D = 160,
  HIP_API_ID_hipModuleGetFunction = 161,
  HIP_API_ID_hipMemsetD32Async = 162,
  HIP_API_ID_hipGetDevice = 163,
  HIP_API_ID_hipGetDeviceCount = 164,
  HIP_API_ID_NUMBER = 165,
...
static inline const char* hip_api_name(const uint32_t id) {
  switch(id) {
    ...
    case HIP_API_ID_hipDrvOccupancyMaxActiveBlocksPerMultiprocessor: return "hipDrvOccupancyMaxActiveBlocksPerMultiprocessor";
    ...
    case HIP_API_ID_hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags: return "hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags";
...
// hipDrvOccupancyMaxActiveBlocksPerMultiprocessor[('int*', 'numBlocks'), ('hipFunction_t', 'f'), ('int', 'blockSize'), ('size_t', 'dynSharedMemPerBlk')]
#define INIT_hipDrvOccupancyMaxActiveBlocksPerMultiprocessor_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessor.numBlocks = numBlocks; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessor.f = f; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessor.blockSize = blockSize; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessor.dynSharedMemPerBlk = dynSharedMemPerBlk; \
};
...
// hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags[('int*', 'numBlocks'), ('hipFunction_t', 'f'), ('int', 'blockSize'), ('size_t', 'dynSharedMemPerBlk'), ('unsigned int', 'flags')]
#define INIT_hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.numBlocks = numBlocks; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.f = f; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.blockSize = blockSize; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.dynSharedMemPerBlk = dynSharedMemPerBlk; \
  cb_data.args.hipDrvOccupancyMaxActiveBlocksPerMultiprocessorWithFlags.flags = flags; \
};
...
#define INIT_hipExtModuleLaunchKernel_CB_ARGS_DATA(cb_data) { \
  cb_data.args.hipExtModuleLaunchKernel.f = f; \
  cb_data.args.hipExtModuleLaunchKernel.globalWorkSizeX = globalWorkSizeX; \
  cb_data.args.hipExtModuleLaunchKernel.globalWorkSizeY = globalWorkSizeY; \
  cb_data.args.hipExtModuleLaunchKernel.globalWorkSizeZ = globalWorkSizeZ; \
  cb_data.args.hipExtModuleLaunchKernel.localWorkSizeX = localWorkSizeX; \
  cb_data.args.hipExtModuleLaunchKernel.localWorkSizeY = localWorkSizeY; \
  cb_data.args.hipExtModuleLaunchKernel.localWorkSizeZ = localWorkSizeZ; \
  cb_data.args.hipExtModuleLaunchKernel.sharedMemBytes = sharedMemBytes; \
  cb_data.args.hipExtModuleLaunchKernel.hStream = hStream; \
  cb_data.args.hipExtModuleLaunchKernel.kernelParams = kernelParams; \
  cb_data.args.hipExtModuleLaunchKernel.extra = extra; \
  cb_data.args.hipExtModuleLaunchKernel.startEvent = startEvent; \
  cb_data.args.hipExtModuleLaunchKernel.stopEvent = stopEvent; \
  cb_data.args.hipExtModuleLaunchKernel.flags = flags; \
};
