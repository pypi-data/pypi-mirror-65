...
def ideal_mixture(chemicals,
    ...
    Hvap = IdealMixtureProperty([getfield(i, 'Hvap') for i in chemicals], 'Hvap')
    sigma = IdealMixtureProperty([getfield(i, 'sigma') for i in chemicals], 'sigma')
    epsilon = IdealMixtureProperty([getfield(i, 'epsilon') for i in chemicals], 'epsilon')
