...
* Apply Flake8 standar
* Configure settings and requirements
* Add django-file-upload-to package
* Add field is_public to mailbox model
* Add field owner to mailbox model
* Remove `Django<=1.*` support
  - Delete south_migrations
* Improved tests about Path locations
...
* Fixes `#13 <https://github.com/panttojo/django-mailbox/issues/13>`_;
