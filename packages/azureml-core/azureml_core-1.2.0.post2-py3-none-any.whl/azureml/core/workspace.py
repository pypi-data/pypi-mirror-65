...
class Workspace(object):
    ...
    * `Azure Machine Learning
    ...
    def update(self, friendly_name=None, description=None, tags=None, image_build_compute=None,
        ...
        :param enable_data_actions: A flag, when set to true, enables data plane action enforcement on the workspace.
            Note that enabling this flag prevents pre-built Azure roles like Owner or Contributor to perform
            data actions in the service. An example of such a data action is
            Microsoft.MachineLearningServices/workspaces/experiments/write, which allows a user to create or update
            experiments in a workspace. Read more here:
            https://docs.microsoft.com/en-us/azure/machine-learning/how-to-assign-roles.
        :type enable_data_actions: bool
        :return: Update information in dict format
        :rtype: dict
        """
        if enable_data_actions is not None:
            if enable_data_actions:
                logging.warning("Note, this will enable data plane action enforcement on this workspace. "
                ...
                logging.warning("Note, this will disable data plane action enforcement on this workspace. "
        ...
        workspace_autorest = _commands.update_workspace(self._auth, self._resource_group,
                                                        ...
                                                        enable_data_actions=enable_data_actions)
