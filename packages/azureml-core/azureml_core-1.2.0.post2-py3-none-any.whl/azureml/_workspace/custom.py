...
def ml_workspace_update(client, resource_group_name, workspace_name, friendly_name=None,
                        description=None, tags=None, image_build_compute=None, enable_data_actions=None):
    """
    ...
    if friendly_name is None and description is None and \
       tags is None and image_build_compute is None and enable_data_actions is None:
        return workspace
    else:
