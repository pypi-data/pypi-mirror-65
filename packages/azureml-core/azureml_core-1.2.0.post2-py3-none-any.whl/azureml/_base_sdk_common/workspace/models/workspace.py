...
class Workspace(Resource):
    ...
    :param private_endpoint_connections: List of private end points of a workspace.
    :type private_endpoint_connections: list[~machinelearningservices.models.PrivateEndPointConnections]
    :param enable_data_actions: A flag, when true, enables data plane action enforcement on the workspace.
    ...
    _attribute_map = {
        ...
        'enable_data_actions': {'key': 'properties.enableDataActions', 'type': 'bool'}
    }
    ...
    def __init__(self, location=None, tags=None, description=None, friendly_name=None,
                 ...
                 discovery_url=None, private_endpoint_connections=None, enable_data_actions=None):
        ...
        self.enable_data_actions = enable_data_actions
