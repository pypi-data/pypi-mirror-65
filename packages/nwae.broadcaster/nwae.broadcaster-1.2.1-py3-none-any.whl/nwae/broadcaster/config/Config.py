...
class Config(baseconfig.BaseConfig):
    ...
    PARAM_SESSION_FEED_KEYS = 'session_feed_keys'
    DEFVAL_SESSION_FEED_KEYS = 'provider'
    ...
    def reload_config(
        ...
        try:
            ...
            session_keys = self.param_value[Config.PARAM_SESSION_FEED_KEYS]
            if session_keys is None:
                self.param_value[Config.PARAM_SESSION_FEED_KEYS] = []
            else:
                self.param_value[Config.PARAM_SESSION_FEED_KEYS] = session_keys.split(',')
            lg.Log.important(
                str(self.__class__) + ' ' + str(getframeinfo(currentframe()).lineno) \
                + ': Session feed keys split to: '
                + str((self.param_value[Config.PARAM_SESSION_FEED_KEYS]))
            )
    ...
    def reset_default_config(
        ...
        param_values_to_set = {
            ...
            Config.PARAM_SESSION_FEED_KEYS: Config.DEFVAL_SESSION_FEED_KEYS,
        }
