...
from mosaik_scenario_tools.scenario_tools.simulator.compressed_data_flow. \
    deflate_module import deflate_data_logged
from mosaik_scenario_tools.scenario_tools.simulator.compressed_data_flow. \
    deflate_simulator_meta import DEFLATE_SIMULATOR_META
from mosaik_scenario_tools.scenario_tools.simulator.compressed_data_flow. \
...
class DeflateSimulator(Simulator):
    def __init__(self):
        super().__init__(meta=DEFLATE_SIMULATOR_META)

        self._data: dict = {}
        self._eid: str = DeflateSimulator.__name__
        self._model: DeflateSourceModel = None
