...
class build_ext(_build_ext):
    ...
    def finalize_options(self):
        ...
        # we'll need to modify later
        #self.user = True

        _build_ext.finalize_options(self)

        # Modify the rpath to get the correct directory where the shared libraries are installed
        print(dir(self))
        print('get_ext_fullpath:', self.build_lib)
