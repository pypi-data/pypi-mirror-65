...
class ImportExportClient:
    """
    [ImportExport.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.can_paginate)
        """

    def cancel_job(self, JobId: str, APIVersion: str = None) -> CancelJobOutputTypeDef:
        """
        [Client.cancel_job documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.cancel_job)
        """
    ...
    def create_job(
        ...
        """
        [Client.create_job documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.create_job)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.generate_presigned_url)
        """
    ...
    def get_shipping_label(
        ...
        """
        [Client.get_shipping_label documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.get_shipping_label)
        """

    def get_status(self, JobId: str, APIVersion: str = None) -> GetStatusOutputTypeDef:
        """
        [Client.get_status documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.get_status)
        """
    ...
    def list_jobs(
        ...
        """
        [Client.list_jobs documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.list_jobs)
        """
    ...
    def update_job(
        ...
        """
        [Client.update_job documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Client.update_job)
        """

    @overload
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Paginator.ListJobs documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/importexport.html#ImportExport.Paginator.ListJobs)
        """
