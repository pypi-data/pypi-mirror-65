...
class Stream:
    ...
    def vrfy_scte35(self,pid, four,seventeen):
        '''
        vrfy_scte35 tests for attributes
        required by a scte35 packet,
        '''
        if self.PID and (pid != self.PID): return False
        # SCTE35_TID (0xfc) is required .
        if  four != self.SCTE35_TID: return False
    ...
    def parse_tspacket(self, packet):
        ...
        if self.vrfy_scte35(pid,packet[4],packet[17]): 
