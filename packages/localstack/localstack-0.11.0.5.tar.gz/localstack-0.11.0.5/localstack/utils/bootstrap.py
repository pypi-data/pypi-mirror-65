...
def load_plugin_from_path(file_path, scope=None):
    if os.path.exists(file_path):
        ...
        try:
            ...
            if "cannot import name 'register_localstack_commands'" not in str(e):
                print('Unable to load plugins for module "%s": %s' % (module, e))
        ...
        try:
            ...
            show_debug = True
            if show_debug or not os.environ.get(ENV_SCRIPT_STARTING_DOCKER):
