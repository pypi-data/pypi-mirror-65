...
function GetOciCommandsToLongParams_oce() {
    $ociCommandsToLongParams = @{
        ...
        'oce oce-instance create' = 'admin-email compartment-id defined-tags description freeform-tags from-json help idcs-access-token identity-stripe instance-usage-type max-wait-seconds name object-storage-namespace tenancy-id tenancy-name waf-primary-domain wait-for-state wait-interval-seconds'
