...
class TestCorpusClassic(unittest.TestCase):
    ...
    def compare_unthresholded_recurrence_plot_results(self,
        ...
        recurrence_plot_result_difference_rounded = np.around(recurrence_plot_result_2.recurrence_matrix - \
                                                              recurrence_plot_result_1.recurrence_matrix,
                                                              decimals=5)

        recurrence_plot_difference = np.count_nonzero(recurrence_plot_result_difference_rounded)
