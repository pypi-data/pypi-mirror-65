...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v1.4.0-alpha.1586279487+g79cd927'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v1.4.0-alpha.1586279487+g79cd927`
                """)
            else:
                raise
