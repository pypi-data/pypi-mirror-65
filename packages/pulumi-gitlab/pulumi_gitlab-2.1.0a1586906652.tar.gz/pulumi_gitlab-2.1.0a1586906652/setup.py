...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.1.0-alpha.1586906652+gbd6acb7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.1.0-alpha.1586906652+gbd6acb7`
                """)
            else:
                raise
