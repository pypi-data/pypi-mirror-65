...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v1.4.0-alpha.1586376161+g7b7a6bc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v1.4.0-alpha.1586376161+g7b7a6bc`
                """)
            else:
                raise
