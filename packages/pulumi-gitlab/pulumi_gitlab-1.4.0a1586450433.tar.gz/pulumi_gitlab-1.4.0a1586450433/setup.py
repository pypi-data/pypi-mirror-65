...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v1.4.0-alpha.1586450433+g4fe6ce2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v1.4.0-alpha.1586450433+g4fe6ce2`
                """)
            else:
                raise
