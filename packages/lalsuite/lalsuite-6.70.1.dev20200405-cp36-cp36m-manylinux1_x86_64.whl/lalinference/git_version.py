...
id = "382fec5bc60a84f27cdd3832385cb0f31d1d6b3b"
date = "2020-04-4 20:52:19 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "382fec5bc60a84f27cdd3832385cb0f31d1d6b3b":
        return
    msg = "Program id (382fec5bc60a84f27cdd3832385cb0f31d1d6b3b) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
