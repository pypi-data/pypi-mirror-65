...
* ``cp clouds.yml.example inventory/group_vars/all/clouds.yml`` and edit to match `openrc.sh`
* ``( cd inventory/group_vars/all ; mv production_domain.yml domain.yml )`` and edit to match `openrc.sh`
