...
class ListRepositoryAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRepositoryAssociations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/codeguru-reviewer.html#CodeGuruReviewer.Paginator.ListRepositoryAssociations.paginate)
        """
