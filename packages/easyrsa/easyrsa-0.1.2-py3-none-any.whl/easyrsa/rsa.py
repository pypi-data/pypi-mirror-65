...
class EasyRSA(object):
    def __init__(self, bits: int = None,
        ...
        if not ((self.public_key is None and self.private_key is None and self.key is not None) or
                (self.key is None and self.private_key is None and self.public_key is not None) or
                (self.public_key is None and self.key is None and self.private_key is not None)):
