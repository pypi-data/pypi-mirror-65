...
class TrainingPipelineSchema(object):
    ...
    def __init__(self, config_file_path=None, created_at=None, created_by=None, id=None, last_run_at=None, model_id=None, name=None, object='trainingPipeline', password=None, pipeline_name=None, project_id=None, ref=None, secret_names=None, source=None, updated_at=None, uri=None, username=None, **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, config_file_path=None, created_at=None, created_by=None, id=None, last_run_at=None, model_id=None, name=None, object='trainingPipeline', password=None, pipeline_name=None, project_id=None, ref=None, secret_names=None, source=None, updated_at=None, uri=None, username=None, **kwargs):  # noqa: E501
    ...
    def pipeline_name(self, pipeline_name):
        ...
        :type: str
        """
        if pipeline_name is not None and len(pipeline_name) > 1000:
            raise ValueError("Invalid value for `pipeline_name`, length must be less than or equal to `1000`")  # noqa: E501
