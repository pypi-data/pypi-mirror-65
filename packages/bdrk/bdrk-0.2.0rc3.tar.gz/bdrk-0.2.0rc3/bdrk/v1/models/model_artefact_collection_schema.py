...
class ModelArtefactCollectionSchema(object):
    ...
    def __init__(self, created_at=None, created_by=None, entity_id=None, id=None, last_version_created_at=None, model_name=None, name=None, object='modelRepository', pipeline_id=None, project_id=None, public_id=None, updated_at=None, **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, created_at=None, created_by=None, entity_id=None, id=None, last_version_created_at=None, model_name=None, name=None, object='modelRepository', pipeline_id=None, project_id=None, public_id=None, updated_at=None, **kwargs):  # noqa: E501
