...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.6.0-alpha.1586553368+g2aabe3c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.6.0-alpha.1586553368+g2aabe3c`
                """)
            else:
                raise
