...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.6.0-alpha.1586285226+g2dadef4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.6.0-alpha.1586285226+g2dadef4`
                """)
            else:
                raise
