...
class PluginManifest(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* A manifest
    ...
    def is_dirty(self):
        return any([self._has_virtual_reconfigure[1], self._has_linked_status[1], self._has_linked_pre_snapshot[1], self._has_virtual_stop[1], self._migration_id_list[1], self._has_virtual_status[1], self._has_virtual_configure[1], self._has_linked_worker[1], self._has_source_config_discovery[1], self._has_virtual_start[1], self._has_linked_stop_staging[1], self._has_repository_discovery[1], self._has_linked_start_staging[1], self._has_linked_mount_specification[1], self._has_initialize[1], self._has_virtual_post_snapshot[1], self._has_virtual_mount_specification[1], self._has_linked_post_snapshot[1], self._has_virtual_pre_snapshot[1], self._has_virtual_unconfigure[1]])
