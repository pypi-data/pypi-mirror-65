...
class Plugin(AbstractToolkit):
    ...
    *(extends* :py:class:`v1_11_1.web.vo.AbstractToolkit` *)* An installed
    ...
    def is_dirty(self):
        return any([self._discovery_definition[1], self._upgrade_definition[1], self._virtual_source_definition[1], self._manifest[1], self._build_number[1], self._linked_source_definition[1], self._entry_point[1], self._source_code[1], self._external_version[1]])
