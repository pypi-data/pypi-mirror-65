...
class VaultCredential(Credential):
    """
    *(extends* :py:class:`v1_11_1.web.vo.Credential` *)* The password vault
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if "vault" not in data:
            raise ValueError("Missing required property \"vault\".")
        ...
        if "vaultCredentialId" not in data:
            raise ValueError("Missing required property \"vaultCredentialId\".")
