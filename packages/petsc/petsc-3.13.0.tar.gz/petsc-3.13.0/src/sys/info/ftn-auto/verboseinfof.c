...
PETSC_EXTERN void  petscinfogetinfo_(PetscBool *infoEnabled,PetscBool *setup,PetscBool *exclude,PetscBool *locked,PetscInfoCommFlag *commSelfFlag, int *__ierr){
*__ierr = PetscInfoGetInfo(infoEnabled,setup,exclude,locked,commSelfFlag);
}
