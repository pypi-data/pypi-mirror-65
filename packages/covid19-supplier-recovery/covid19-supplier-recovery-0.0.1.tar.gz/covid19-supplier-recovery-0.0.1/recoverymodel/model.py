...
class RecoveryModel:
    ...
    def __init__(
        ...
        """Parameterize the forecast with

        Arguments:
            normal_forecast {List[float]} -- [description]
            lockdowns {List[dict]} -- [description]
            recoveries {List[dict]} -- [description]
        """
    ...
    def model_recovery(self):
        ...
        if len(self._lockdowns) != len(self._recoveries):
            raise Exception("""Provide equal number of lockdown and recovery
        objects.""")
