...
class MimicWrapper(ChainedIdentity):
    ...
    def _explain_large_data(self, eval_dataset, classes=1, memory_cap=8, raw_feature_names=None,
        ...
        if scipy.sparse.issparse(eval_dataset):
            ...
            # estimate densified size - numpy floats should give us about 8 bytes
            eval_dataset_size = rows * eval_dataset.shape[1] * 8
            ...
            eval_dataset_size = sys.getsizeof(eval_dataset)
        ...
        kwargs = {
            ...
            History.GLOBAL_IMPORTANCE_VALUES: global_eng.global_importance_values,
            History.GLOBAL_IMPORTANCE_RANK: global_eng.global_importance_rank,
