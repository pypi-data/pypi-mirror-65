...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.14.0-alpha.1586871786+g1f63708d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.14.0-alpha.1586871786+g1f63708d`
                """)
            else:
                raise
