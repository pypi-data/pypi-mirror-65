...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.13.0-alpha.1586279358+g83c5afe7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.13.0-alpha.1586279358+g83c5afe7`
                """)
            else:
                raise
