...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.13.0-alpha.1586283347+g926cb174'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.13.0-alpha.1586283347+g926cb174`
                """)
            else:
                raise
