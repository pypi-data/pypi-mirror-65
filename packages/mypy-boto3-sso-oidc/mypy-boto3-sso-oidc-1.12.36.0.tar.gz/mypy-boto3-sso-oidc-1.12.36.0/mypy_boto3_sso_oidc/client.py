...
class SSOOIDCClient:
    """
    [SSOOIDC.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client.can_paginate)
        """
    ...
    def create_token(
        ...
        """
        [Client.create_token documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client.create_token)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client.generate_presigned_url)
        """
    ...
    def register_client(
        ...
        """
        [Client.register_client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client.register_client)
        """
    ...
    def start_device_authorization(
        ...
        """
        [Client.start_device_authorization documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.36/reference/services/sso-oidc.html#SSOOIDC.Client.start_device_authorization)
        """
