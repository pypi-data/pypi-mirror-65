...
# from skydl.ray.worker_patch0_7_5 import global_worker as ray075_global_worker
...
def plasma_prefetch(object_id):
    ...
    # local_sched_client = ray075_global_worker.raylet_client
    local_sched_client = ray._raylet.RayletClient(ray.worker.global_worker.core_worker)
