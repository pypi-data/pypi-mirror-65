...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, repository_version=None, name=None, content_guard=None, repository=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
