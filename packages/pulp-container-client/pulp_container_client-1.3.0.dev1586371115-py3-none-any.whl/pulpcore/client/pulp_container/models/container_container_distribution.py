...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, base_path=None, pulp_href=None, content_guard=None, repository=None, name=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
