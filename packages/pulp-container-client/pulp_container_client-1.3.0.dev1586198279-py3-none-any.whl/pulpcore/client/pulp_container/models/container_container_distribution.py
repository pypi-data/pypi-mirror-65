...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, pulp_href=None, content_guard=None, repository=None, repository_version=None, pulp_created=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
