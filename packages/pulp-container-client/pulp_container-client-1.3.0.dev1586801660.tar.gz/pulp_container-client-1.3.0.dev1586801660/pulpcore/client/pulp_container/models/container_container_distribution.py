...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_created=None, pulp_href=None, repository_version=None, base_path=None, name=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
