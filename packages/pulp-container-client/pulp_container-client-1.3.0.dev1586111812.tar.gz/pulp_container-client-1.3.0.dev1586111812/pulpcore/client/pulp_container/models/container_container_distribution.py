...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository_version=None, name=None, pulp_created=None, pulp_href=None, content_guard=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
