...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, content_guard=None, pulp_href=None, base_path=None, repository=None, pulp_created=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
