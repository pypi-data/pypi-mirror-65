...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository_version=None, pulp_href=None, pulp_created=None, content_guard=None, name=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
