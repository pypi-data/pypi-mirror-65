...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, repository_version=None, content_guard=None, pulp_created=None, name=None, repository=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
