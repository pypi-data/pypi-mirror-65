...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, name=None, repository_version=None, pulp_created=None, content_guard=None, pulp_href=None, repository=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
