...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, pulp_created=None, content_guard=None, base_path=None, pulp_href=None, name=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
