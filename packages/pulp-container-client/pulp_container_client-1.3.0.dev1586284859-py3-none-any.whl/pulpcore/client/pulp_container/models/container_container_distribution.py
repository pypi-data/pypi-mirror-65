...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, repository_version=None, repository=None, pulp_created=None, base_path=None, content_guard=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
