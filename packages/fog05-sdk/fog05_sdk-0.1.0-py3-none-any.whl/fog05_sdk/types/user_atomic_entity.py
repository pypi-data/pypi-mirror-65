...
class yc_fdus_user_atomic_entity__ae_descriptor_fdus(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__hypervisor = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'BARE': {}, 'LXD': {}, 'KVM': {}, 'KVM_UK': {}, 'XEN': {}, 'XEN_UK': {}, 'MCU': {}, 'DOCKER': {}},), is_leaf=True, yang_name="hypervisor", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:fog05:im:user:atomicentity', defining_module='user_atomic_entity', yang_type='hv_kind', is_config=True)
  ...
  def _set_hypervisor(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'BARE': {}, 'LXD': {}, 'KVM': {}, 'KVM_UK': {}, 'XEN': {}, 'XEN_UK': {}, 'MCU': {}, 'DOCKER': {}},), is_leaf=True, yang_name="hypervisor", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:fog05:im:user:atomicentity', defining_module='user_atomic_entity', yang_type='hv_kind', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hypervisor must be of a type compatible with hv_kind""",
          'defined-type': "user_atomic_entity:hv_kind",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'BARE': {}, 'LXD': {}, 'KVM': {}, 'KVM_UK': {}, 'XEN': {}, 'XEN_UK': {}, 'MCU': {}, 'DOCKER': {}},), is_leaf=True, yang_name="hypervisor", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:fog05:im:user:atomicentity', defining_module='user_atomic_entity', yang_type='hv_kind', is_config=True)""",
        })
