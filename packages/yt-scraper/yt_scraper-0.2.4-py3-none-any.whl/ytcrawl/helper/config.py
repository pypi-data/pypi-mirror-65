...
from ytcrawl.helper.echo import warning
from ytcrawl import APP_NAME
...
def load_config(config_path=None):
    ...
    -----
        ...
        - Mac OS X: "~/Library/Application Support/YouTube Crawler"
        - Unix: "~/.config/youtube-crawler"
        - Win7: C:\Users\<user>\AppData\Roaming\YouTube Crawler
    """
    if config_path:
