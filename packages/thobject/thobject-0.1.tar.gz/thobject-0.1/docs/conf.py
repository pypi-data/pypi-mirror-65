...
latex_documents = [
    (master_doc, 'thobject.tex', 'thobject Documentation',
...
man_pages = [
    (master_doc, 'thobject', 'thobject Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'thobject', 'thobject Documentation',
     author, 'thobject', 'One line description of project.',
     'Miscellaneous'),
]
