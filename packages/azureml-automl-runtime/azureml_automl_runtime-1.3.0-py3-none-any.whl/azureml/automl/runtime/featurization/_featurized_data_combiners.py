...
class FeaturizedDataCombiners:
    ...
    @staticmethod
    def default_combiner(features: List[Union[np.array, pd.DataFrame, sparse.spmatrix]], **kwargs: Any) -> np.array:
        """
    ...
    @staticmethod
    def sparse_combiner(
            features: List[Union[np.array, pd.DataFrame, sparse.spmatrix]],
