...
class DataTransformer(AutoMLTransformer, FeaturizationInfoProvider):
    ...
    def fit_transform_with_logger(self,
                                  ...
                                  **fit_params: Any) -> Union[pd.DataFrame, np.array, sparse.spmatrix]:
        """
        ...
        transform_out = self.fit_transform(X, y, **fit_params)  # type: Union[pd.DataFrame, np.array]
    ...
    @logging_utilities.function_debug_log_wrapped()
    def transform(self, df: DataInputType) -> Union[pd.DataFrame, np.array, sparse.spmatrix]:
        """
        ...
        ret = combiner(features, **{'working_directory': self.working_directory,
                                    'logger': self.logger,
                                    'pickler': self.pickler})  # type: Union[pd.DataFrame, np.array, sparse.spmatrix]
        return ret
    ...
    def _apply_transforms(self, df: pd.DataFrame) -> List[Union[np.array, pd.DataFrame, sparse.spmatrix]]:
        features = []
