...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v1.7.0-alpha.1586285205+gd519bd0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v1.7.0-alpha.1586285205+gd519bd0`
                """)
            else:
                raise
