...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v1.7.0-alpha.1586555600+gd85edd8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v1.7.0-alpha.1586555600+gd85edd8`
                """)
            else:
                raise
