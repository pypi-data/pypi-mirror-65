...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v1.7.0-alpha.1586470984+gdd94a5d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v1.7.0-alpha.1586470984+gdd94a5d`
                """)
            else:
                raise
