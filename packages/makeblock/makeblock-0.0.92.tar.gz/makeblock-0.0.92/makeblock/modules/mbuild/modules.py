...
class RGBLed(_BaseModule):
    ...
    def set_color(self,red,green,blue):
        ...
        self._pack.data = [0x1]
        self._pack.data.extend(utils.short2bits(red))
        self._pack.data.extend(utils.short2bits(green))
        self._pack.data.extend(utils.short2bits(blue))
...
class LedMatrix(_BaseModule):
    ...
    def set_string(self,msg):
        l = len(msg)
        self._pack.data = [0x7]
        self._pack.data.extend(utils.short2bits(l))
        for i in range(l):
...
class Servo(_BaseModule):
    ...
    def set_angle(self,angle):
        angle = int(angle)
        self._pack.data = [0x1]
        self._pack.data.extend(utils.short2bits(angle))
        self.call(self._pack)
...
class Speaker(_BaseModule):
    ...
    def play_tone(self,hz):
        self._pack.data = [0x2]
        self._pack.data.extend(utils.short2bits(hz))
        self.call(self._pack)
...
class FingertipPiano(_BaseModule):
    ...
    def subscribe_all(self):
        ...
        pack.data.extend(utils.long2bits(300))
        self.subscribe(pack)
    ...
    def set_led(self,red=0,green=0,blue=0):
        ...
        pack.subservice = self._pack.subservice
        pack.data = [0x1]
        pack.data.extend(utils.short2bits(red))
        pack.data.extend(utils.short2bits(green))
        pack.data.extend(utils.short2bits(blue))
        self.call(pack)
