    ...
    def DCMotor(self,port):
        """
            ...
            .. code-block:: python
                ...
                dcmotor = board.DCMotor(mCore.M1)
    ...
    def RGBLed(self,port,slot=2):
        """
            ...
            .. code-block:: python
                ...
                rgbled = board.RGBLed(board,mCore.PORT2)
    ...
    def SevenSegmentDisplay(self,port):
        """
            ...
            .. code-block:: python
                ...
                sevseg = board.SevenSegmentDisplay(PORT2)
    ...
    def LedMatrix(self,port):
        """
            ...
            .. code-block:: python
                ...
                ledmatrix = board.LedMatrix(PORT2)
    ...
    def DSLRShutter(self,port):
        """
            ...
            .. code-block:: python
                ...
                shutter = board.DSLRShutter(PORT2)
    ...
    def InfraredReceiver(self,port):
        """
            ...
            .. code-block:: python
                ...
                ir = board.InfraredReceiver(PORT2)
    ...
    def LineFollower(self,port):
        """
            ...
            .. code-block:: python
                ...
                linefollower = board.LineFollower(PORT2)
    ...
    def LimitSwitch(self,port,slot=2):
        """
            ...
            .. code-block:: python
                ...
                limitswitch = board.LimitSwitch(mCore.PORT2,mCore.SLOT1)
    ...
    def Potentiometer(self,port):
        """
            ...
            .. code-block:: python
                ...
                potentiometer = board.Potentiometer(mCore.PORT2)
    ...
    def Temperature(self,port,slot):
        """
            ...
            .. code-block:: python
                ...
                temp = board.Temperature(PORT2,SLOT1)
