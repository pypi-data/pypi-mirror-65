...
# source: tfmiss/training/hparam.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tfmiss/training/hparam.proto',
  package='tfmiss',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n\x1ctfmiss/training/hparam.proto\x12\x06tfmiss\"\xbe\x04\n\tHParamDef\x12-\n\x06hparam\x18\x01 \x03(\x0b\x32\x1d.tfmiss.HParamDef.HparamEntry\x1a\x1a\n\tBytesList\x12\r\n\x05value\x18\x01 \x03(\x0c\x1a\x1e\n\tFloatList\x12\x11\n\x05value\x18\x01 \x03(\x02\x42\x02\x10\x01\x1a\x1e\n\tInt64List\x12\x11\n\x05value\x18\x01 \x03(\x03\x42\x02\x10\x01\x1a\x1d\n\x08\x42oolList\x12\x11\n\x05value\x18\x01 \x03(\x08\x42\x02\x10\x01\x1a\xb9\x02\n\nHParamType\x12\x15\n\x0bint64_value\x18\x01 \x01(\x03H\x00\x12\x15\n\x0b\x66loat_value\x18\x02 \x01(\x02H\x00\x12\x15\n\x0b\x62ytes_value\x18\x03 \x01(\x0cH\x00\x12\x14\n\nbool_value\x18\x07 \x01(\x08H\x00\x12\x31\n\nint64_list\x18\x04 \x01(\x0b\x32\x1b.tfmiss.HParamDef.Int64ListH\x00\x12\x31\n\nfloat_list\x18\x05 \x01(\x0b\x32\x1b.tfmiss.HParamDef.FloatListH\x00\x12\x31\n\nbytes_list\x18\x06 \x01(\x0b\x32\x1b.tfmiss.HParamDef.BytesListH\x00\x12/\n\tbool_list\x18\x08 \x01(\x0b\x32\x1a.tfmiss.HParamDef.BoolListH\x00\x42\x06\n\x04kind\x1aK\n\x0bHparamEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12+\n\x05value\x18\x02 \x01(\x0b\x32\x1c.tfmiss.HParamDef.HParamType:\x02\x38\x01\x42\x03\xf8\x01\x01\x62\x06proto3')
)
...
_HPARAMDEF_BYTESLIST = _descriptor.Descriptor(
  name='BytesList',
  full_name='tfmiss.HParamDef.BytesList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfmiss.HParamDef.BytesList.value', index=0,
...
_HPARAMDEF_FLOATLIST = _descriptor.Descriptor(
  name='FloatList',
  full_name='tfmiss.HParamDef.FloatList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfmiss.HParamDef.FloatList.value', index=0,
...
_HPARAMDEF_INT64LIST = _descriptor.Descriptor(
  name='Int64List',
  full_name='tfmiss.HParamDef.Int64List',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfmiss.HParamDef.Int64List.value', index=0,
...
_HPARAMDEF_BOOLLIST = _descriptor.Descriptor(
  name='BoolList',
  full_name='tfmiss.HParamDef.BoolList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfmiss.HParamDef.BoolList.value', index=0,
...
_HPARAMDEF_HPARAMTYPE = _descriptor.Descriptor(
  name='HParamType',
  full_name='tfmiss.HParamDef.HParamType',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='int64_value', full_name='tfmiss.HParamDef.HParamType.int64_value', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='float_value', full_name='tfmiss.HParamDef.HParamType.float_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bytes_value', full_name='tfmiss.HParamDef.HParamType.bytes_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool_value', full_name='tfmiss.HParamDef.HParamType.bool_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='int64_list', full_name='tfmiss.HParamDef.HParamType.int64_list', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='float_list', full_name='tfmiss.HParamDef.HParamType.float_list', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bytes_list', full_name='tfmiss.HParamDef.HParamType.bytes_list', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bool_list', full_name='tfmiss.HParamDef.HParamType.bool_list', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='tfmiss.HParamDef.HParamType.kind',
...
_HPARAMDEF_HPARAMENTRY = _descriptor.Descriptor(
  name='HparamEntry',
  full_name='tfmiss.HParamDef.HparamEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tfmiss.HParamDef.HparamEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='tfmiss.HParamDef.HparamEntry.value', index=1,
...
_HPARAMDEF = _descriptor.Descriptor(
  name='HParamDef',
  full_name='tfmiss.HParamDef',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hparam', full_name='tfmiss.HParamDef.hparam', index=0,
...
HParamDef = _reflection.GeneratedProtocolMessageType('HParamDef', (_message.Message,), dict(
  ...
  BytesList = _reflection.GeneratedProtocolMessageType('BytesList', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.BytesList)
    ))
  ,
  ...
  FloatList = _reflection.GeneratedProtocolMessageType('FloatList', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.FloatList)
    ))
  ,
  ...
  Int64List = _reflection.GeneratedProtocolMessageType('Int64List', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.Int64List)
    ))
  ,
  ...
  BoolList = _reflection.GeneratedProtocolMessageType('BoolList', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.BoolList)
    ))
  ,
  ...
  HParamType = _reflection.GeneratedProtocolMessageType('HParamType', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.HParamType)
    ))
  ,
  ...
  HparamEntry = _reflection.GeneratedProtocolMessageType('HparamEntry', (_message.Message,), dict(
    ...
    __module__ = 'tfmiss.training.hparam_pb2'
    # @@protoc_insertion_point(class_scope:tfmiss.HParamDef.HparamEntry)
    ))
  ,
  DESCRIPTOR = _HPARAMDEF,
  __module__ = 'tfmiss.training.hparam_pb2'
  # @@protoc_insertion_point(class_scope:tfmiss.HParamDef)
  ))
