...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.11.0-alpha.1586287363+gd3073a4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.11.0-alpha.1586287363+gd3073a4`
                """)
            else:
                raise
