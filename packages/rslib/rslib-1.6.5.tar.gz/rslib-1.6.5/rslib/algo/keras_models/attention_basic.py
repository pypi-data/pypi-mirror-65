...
def get_model(config):
    ...
    # seq_week_id_embeddings = layers.Embedding(7, seq_week_id_output, mask_zero=True)(seq_week_id_input)
    # label_week_id_embeddings = layers.Embedding(7, label_week_id_output, mask_zero=True)(label_week_id_input)
    # embeddings = layers.Concatenate(axis=-1)([seq_id_embeddings, seq_week_id_embeddings, label_week_id_embeddings])
    ...
    temp_input = embeddings, seq_time, seq_time_gaps
