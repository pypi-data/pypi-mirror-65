...
inUrl = "https://igtools3.github.io"

def readFile(file, newline=None):
	# Open File
	f = open(file, "r").read()
	# If newline = True
	if newline:
...
def uaList():
	...
	"Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/19.77.34.5 Safari/517.1",
