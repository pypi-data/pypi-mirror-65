...
class Agent(object):
    def __init__(self, app_name: str, key_pair: key_pair_format) -> None:
        ...
        self.__hmac = lambda v: self.__check() and self.__setk(key_pair["public_key"], v)
    ...
    def rm(self, id: str, pw: str, k: str) -> bool:
        return Broker(app_name=self.__app_name, username=self.__hmac(id)).rm(self.__setk(pw, k))
