...
class ApiClient(object):
    """Client for CDS API implementation.

    This class handles the client-server communication, and is invariant across CDS API implementations.   
    ...
    Replace 'https://data.holder.com.au' with the API host address
    """
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'cds-python-api-client/0.0.2'
