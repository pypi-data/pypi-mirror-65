...
class FTL_Test(TestCase):
    def workflow_status(self, instance, status):
        obj = ProcessInstance.objects.get_process_by_instance(instance).first()
        _status = obj.status
...
class Workflow_Test(CRUD_Test):
    ...
    def test_update(self, formset_delete=False, post_update=None):
        ...
        self.instance = ProcessInstance.objects.get_process_by_instance(self.instance).first().content_object
