...
class Core(CoreClients):
    ...
    def upload_to_s3(self, filepath: str, object_key_name: str, bucket_name: str, region_name: str) -> bool:
        ...
        try:
            ...
            print(f"Almost there ! You just need to configure your AWS credentials."
            ...
            if click.confirm("Press Y to access the video."):
                ...
                if selected_language == "English":
                    print("English here you go !")
                elif selected_language == "French":
                    print("Français la voila !")
                print("Follow the instructions that is available in the video, then when you are all set up, redo the command you just tried")
                while True:
                ...
                print("Ok, then follow the boto documentation, and once you have configured your credentials, relaunch the cli command that you were trying to use"
