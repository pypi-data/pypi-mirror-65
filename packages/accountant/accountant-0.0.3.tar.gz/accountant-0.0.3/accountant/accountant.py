from ledger_system.client import LedgerClient
...
class Accountant:
    ...
    def create_book(account_id):
        log.info("---------New_ledger-------------")
        block_book_id = account_id.ledger.create_book(name=f"{account_id.bank_account['account_id']}_block_book",
                                                min_balance="-100")
        main_book_id = account_id.ledger.create_book(name=f"{account_id.bank_account['account_id']}_main_book", min_balance="-100")
        new_books = {
