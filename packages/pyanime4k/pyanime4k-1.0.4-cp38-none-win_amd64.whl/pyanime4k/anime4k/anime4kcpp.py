...
class Anime4K(object):
    ...
    def __init__(self, *args):
        r"""__init__(Anime4K self, int passes=2, int pushColorCount=2, double strengthColor=0.3, double strengthGradient=1.0, double zoomFactor=2.0, bool fastMode=False, bool videoMode=False, bool postProcessing=False, uint8_t filters=12, unsigned int maxThreads=std::thread::hardware_concurrency()) -> Anime4K"""
    ...
    def showFiltersInfo(self) -> "void":
        r"""showFiltersInfo(Anime4K self)"""
        return _anime4kcpp.Anime4K_showFiltersInfo(self)
