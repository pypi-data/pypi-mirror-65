...
def showImg2X(src, *args):
    ...
    Default args:
    int passes=2, int pushColorCount=2, double strengthColor=0.3, 
    double strengthGradient=1.0, double zoomFactor=2.0, bool fastMode=False, 
    bool videoMode=False(do not change it), bool postProcessing=False, uint8_t filters=12, 
...
def cvtVideo2X(srcList, dstSuffix="_output", dstPath=None, *args):
    ...
    Default args:
    int passes=1, int pushColorCount=2, double strengthColor=0.3, 
    double strengthGradient=1.0, double zoomFactor=2.0, bool fastMode=False, 
    bool videoMode=True(do not change it), bool postProcessing=False, uint8_t filters=12, 
    unsigned int maxThreads=std::thread::hardware_concurrency()
    """
