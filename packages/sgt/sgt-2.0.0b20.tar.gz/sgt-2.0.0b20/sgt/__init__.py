...
#         return self
#
#     def __set_feature_names(self, sgt):
#         sgt = pd.DataFrame(sgt)
#         feature_names = list(iterproduct(self.alphabets, self.alphabets))
#         sgt.columns = feature_names
#         return sgt
#
...
#             return self.__set_feature_names(sgt)
