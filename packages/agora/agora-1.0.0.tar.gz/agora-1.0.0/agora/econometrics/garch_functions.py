...
from .optimization import QuickMin,
from .optimization import ConvergenceError, Hessian_FD_g
...
def GARCH11_grid_search(o_range, a_range, b_range, args, verbose=False):
    ...
    for o0 in o_range:
        ...
        g_parms = (
              [o0, a_range[amin], b_range[bmin]] if g_min == zmin else g_parms)
...
def IGarch11(ret, skip=10):
    ...
    if not res["success"]:
        raise ConvergenceError(
                "IGarch11: linear optimization couldn't converge")
