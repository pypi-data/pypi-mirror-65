...
class JupyterVersionUpdateHandler(IPythonHandler):
    ...
    def upgrade(self):
        try:
            ...
            pre_releases_enabled = (os.getenv('INSTALL_JUPYTER_EXTENSIONS_RC', 0) == '1')

            version_checker.install_python_package_version('jupyter_forest_extension', pre=pre_releases_enabled)

            if pre_releases_enabled:
