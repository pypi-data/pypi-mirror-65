...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.8.0-alpha.1586376136+g0d3fa24'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.8.0-alpha.1586376136+g0d3fa24`
                """)
            else:
                raise
