...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.8.0-alpha.1586556547+g2d9f951'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.8.0-alpha.1586556547+g2d9f951`
                """)
            else:
                raise
