...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.7.0-alpha.1585915142+gb107444'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.7.0-alpha.1585915142+gb107444`
                """)
            else:
                raise
