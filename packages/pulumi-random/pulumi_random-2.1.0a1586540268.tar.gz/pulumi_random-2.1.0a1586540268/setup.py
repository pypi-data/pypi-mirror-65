...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v2.1.0-alpha.1586540268+g4a1de37'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v2.1.0-alpha.1586540268+g4a1de37`
                """)
            else:
                raise
