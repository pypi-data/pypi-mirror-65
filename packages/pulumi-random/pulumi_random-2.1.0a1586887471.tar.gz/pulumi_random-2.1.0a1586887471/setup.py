...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v2.1.0-alpha.1586887471+g45e1d00'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v2.1.0-alpha.1586887471+g45e1d00`
                """)
            else:
                raise
