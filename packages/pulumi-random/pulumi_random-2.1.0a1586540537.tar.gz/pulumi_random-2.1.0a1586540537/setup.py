...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v2.1.0-alpha.1586540537+gaac8346'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v2.1.0-alpha.1586540537+gaac8346`
                """)
            else:
                raise
