...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', 'v1.8.0-alpha.1586888145+g3c76cda'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random v1.8.0-alpha.1586888145+g3c76cda`
                """)
            else:
                raise
