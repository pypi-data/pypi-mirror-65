...
def renameh(dir):
    '''
    This funcion work of VNIR sensor file and does the renaming to .zip for you. works a directory level
    '''
...
def unziph(dir):
    '''
    This funcion works at sensor directory level and unzips the file while removing garabage xml file
    '''
    for filename in os.listdir(dir):
...
def raw2nph(direc):
    ...
    Parameter::
    --------
    str: last directoy directory at which files reside
    Output::
    -------
    numpy array: This converts to numpy format and works at directory level
    '''
    img=None
    for filename in os.listdir(direc):
        if filename.endswith(".raw"):
            ...
            try:
                ...
                pass
            try:
                img=rimg.reshape(454,400)
            except:
                pass
            try:
                img=rimg.reshape(452,400)
            except:
                pass
