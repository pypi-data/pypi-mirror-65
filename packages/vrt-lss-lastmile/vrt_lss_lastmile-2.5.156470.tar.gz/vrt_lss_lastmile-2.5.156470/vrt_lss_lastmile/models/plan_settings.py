...
class PlanSettings(object):
    ...
    def __init__(self, configuration='default', planning_time=20, result_ttl=20, result_timezone=0, predict_slots=0, transport_factor=None, routing=None, assumptions=None, precision=3):  # noqa: E501
