...
if __name__ == "__main__":
    ...
    example_data_loader = DataLoader(user_name, password)

    data_example = LoadDataFromDB(user_name, password)

    data_df =  data_example.get_data('index_price', column_names = ['date', 'open'], select_columns = ['datetime', 'order_book_id'], aim_values = ['20140224', '000001.XSHG'])

    #取出全部
    # data_df = example_data_loader.get_nav()
    #
    # #按时间取
    # data_df2 = example_data_loader.get_nav(start_time = '20200122', end_time = '20200123')
