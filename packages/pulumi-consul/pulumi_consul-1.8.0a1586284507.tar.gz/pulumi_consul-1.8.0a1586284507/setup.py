...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.8.0-alpha.1586284507+g960aec3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.8.0-alpha.1586284507+g960aec3`
                """)
            else:
                raise
