...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.8.0-alpha.1586552667+g693ac1d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.8.0-alpha.1586552667+g693ac1d`
                """)
            else:
                raise
