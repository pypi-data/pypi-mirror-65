...
class ListServersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListServers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.39/reference/services/transfer.html#Transfer.Paginator.ListServers.paginate)
        """
