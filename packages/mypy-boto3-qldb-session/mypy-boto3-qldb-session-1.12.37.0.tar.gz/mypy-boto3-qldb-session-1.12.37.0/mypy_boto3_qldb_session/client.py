...
class QLDBSessionClient:
    """
    [QLDBSession.Client documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/qldb-session.html#QLDBSession.Client)
    """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Client.can_paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/qldb-session.html#QLDBSession.Client.can_paginate)
        """
    ...
    def generate_presigned_url(
        ...
        """
        [Client.generate_presigned_url documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/qldb-session.html#QLDBSession.Client.generate_presigned_url)
        """
    ...
    def send_command(
        ...
        """
        [Client.send_command documentation](https://boto3.amazonaws.com/v1/documentation/api/1.12.37/reference/services/qldb-session.html#QLDBSession.Client.send_command)
        """
