...
class Adjustment(GLXCurses.Object):
    ...
    def set_value(self, value):
        ...
        if type(value) == float:
            ...
            value = GLXCurses.clamp(
                value=value,
                smallest=self.get_lower(),
                largest=self.get_upper()
            )
    ...
    def clamp_page(self, lower=None, upper=None):
        ...
        # Clamp
        lower = GLXCurses.clamp(value=lower, smallest=self.get_lower(), largest=self.get_upper())
        upper = GLXCurses.clamp(value=upper, smallest=self.get_lower(), largest=self.get_upper())
