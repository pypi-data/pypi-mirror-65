...
class Config(baseconfig.BaseConfig):
    ...
    # NLP Samples for unit testing, etc.
    PARAM_NLP_DIR_SAMPLE_DATA = 'dir_sample_data'
    DEFVAL_NLP_DIR_SAMPLE_DATA = None
    ...
    def reset_default_config(
        ...
        param_values_to_set = {
            ...
            # NLP Samples for unit testing, etc.
            Config.PARAM_NLP_DIR_SAMPLE_DATA: Config.DEFVAL_NLP_DIR_SAMPLE_DATA,
        }
    ...
    def __reconfigure_paths_requiring_topdir(self):
        ...
        # NLP Samples for unit testing, etc.
        if self.param_value[Config.PARAM_NLP_DIR_SAMPLE_DATA] is None:
            self.param_value[Config.PARAM_NLP_DIR_SAMPLE_DATA] = topdir + '/nlp.data/samples'
