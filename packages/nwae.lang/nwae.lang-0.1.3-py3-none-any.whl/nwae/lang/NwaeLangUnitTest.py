...
class NwaeLangUnitTest:
    ...
    def run_unit_tests(self):
        ...
        res_final.update(other_res_obj=res)
        Log.critical('Edit Distance (DLev, Lev) Unit Test PASSED ' + str(res.count_ok) + ', FAILED ' + str(res.count_fail))
        ...
        res_final.update(other_res_obj=res)
        Log.critical('Spell Check Word Unit Test PASSED ' + str(res.count_ok) + ', FAILED ' + str(res.count_fail))

        res = SpellCheckSentenceUnitTest(ut_params=self.ut_params).run_unit_test()
        res_final.update(other_res_obj=res)
        Log.critical('Spell Check Sentence Unit Test PASSED ' + str(res.count_ok) + ', FAILED ' + str(res.count_fail))
