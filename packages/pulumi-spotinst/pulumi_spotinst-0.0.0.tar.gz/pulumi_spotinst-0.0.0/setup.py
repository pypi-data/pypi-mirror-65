...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v1.3.0-alpha.1586170139+g7558a89'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v1.3.0-alpha.1586170139+g7558a89`
                """)
            else:
                raise
