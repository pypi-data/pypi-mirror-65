...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v1.3.0-alpha.1586468100+g87e5c06'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v1.3.0-alpha.1586468100+g87e5c06`
                """)
            else:
                raise
