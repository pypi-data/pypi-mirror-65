...
class ContentModulemdDefaultsApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['module', 'module__in', 'stream', 'stream__in', 'sha256', 'repository_version', 'repository_version_added', 'repository_version_removed', 'ordering', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
