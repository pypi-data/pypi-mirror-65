...
class ContentPackagesApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'name__in', 'name__ne', 'epoch', 'epoch__in', 'epoch__ne', 'version', 'version__in', 'version__ne', 'release', 'release__in', 'release__ne', 'arch', 'arch__in', 'arch__ne', 'pkg_id', 'pkg_id__in', 'checksum_type', 'checksum_type__in', 'checksum_type__ne', 'sha256', 'repository_version', 'repository_version_added', 'repository_version_removed', 'ordering', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
