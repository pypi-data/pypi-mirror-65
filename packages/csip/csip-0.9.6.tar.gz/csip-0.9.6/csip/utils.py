"""
 * $Id: 0.9+6 utils.py 88227807c1f8 2020-04-02 od $
 *
...
class Client(object):
    ...
    def __init__(self, data: Dict = None, metainfo: Dict = None,
        ...
        # default delay for pubsub submission, default none
        self.pubsub_delay = 0
    ...
    def pubsub(self, url: str, callback=None) -> None:
        ...
        for i, file in enumerate(glob.iglob(self._files)):
            ...
            callback(resp, file, i)
            if self.pubsub_delay > 0:
                sleep(self.pubsub_delay / 1000)
