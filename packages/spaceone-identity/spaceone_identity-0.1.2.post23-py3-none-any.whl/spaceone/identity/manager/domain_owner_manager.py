...
class DomainOwnerManager(BaseManager):
    ...
    def get_owner(self, domain_id, owner_id=None):
        if owner_id:
            return self.domain_owner_model.get(domain_id=domain_id, owner_id=owner_id)
        else:
            return self.domain_owner_model.get(domain_id=domain_id)
