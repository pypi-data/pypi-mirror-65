...
if __name__ == "__main__":
    ...
    # session.auth = ('twcadm', 'zxcv1234')
    # session.verify = False
    # session.cert = ("/opt/tcpwave/certs/client.crt", "/opt/tcpwave/certs/client.key")
    #
    # parameters = {
    #     "entity": "network",
    #     "page": 1,
    ...
    #     'Content-Type': 'text/plain'
    # }
    # rsp = session.get('https://192.168.0.116:7443/tims/rest/network/list', params=parameters, headers=header)
    # print(rsp)
    # nw = NetworkManager()
    # data = {
    ...
    # }
    # nw.create_network(json.dumps(data))
    # p = {
    #     "a": 1,
    #     "e": "someting",
    #     "b": {
