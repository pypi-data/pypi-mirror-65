...
parser.add_argument ('-scr', metavar='<file>', help = 'Fichero de pantalla de carga SCR.', type = str, action = 'store')
parser.add_argument ('-mdg', metavar='<file>', help = 'Fichero de gráficos MDG para MSX.', type = str, action = 'store')
...
print ()
print (' Daad2MsxCas : MSX DAAD-CAS Maker versión 1.0b1 200403 (c) 2020 Pedro Fernández.')
...
in_file=in_file.replace('.ddb', '.cas')
if not (in_file.endswith('.cas')):
        in_file = in_file + '.cas' 

with open(in_file, 'wb') as a:
        a.write(casFile)

print ('Fichero', in_file, 'creado.')
print ()
