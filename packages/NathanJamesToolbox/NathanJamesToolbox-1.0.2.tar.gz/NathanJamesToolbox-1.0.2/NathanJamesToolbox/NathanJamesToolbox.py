...
class FlexportToolbox:
    def __init__(self, token):
        ...
        self.token = token
        self.headers = {'Accept': 'application/vnd.flexport.v1',
                        'Flexport-Version': '2',
...
if __name__ == '__main__':
    myPath = __file__[:__file__.rfind('/') + 1]
    bases = {'testBase': 'appgg2Dz6pmuRMwiQ', 'prodBase': 'appeHvOljHqhtu561'}
    myBase = bases.get('prodBase')
    _airtable = airtableToolbox(myBase, 'keyNmj9UPTIBu4jMR')

    _slack = slackToolbox('xoxb-67057974501-803275864324-FcYkxAcDNLNH54PUN83ABuft', '#python_automation_alert')
    _mySQL = mySQLToolbox(myPath, host="35.222.123.221", user="root", password="NathanJames!23", db="NathanJames")
    _flexport = FlexportToolbox('dfa4b89d0cb6217b2120cc7ee4daf3c7')
    _cin7 = Cin7Toolbox('BlueFyn4US', '9a8b8d0e8073420c9f3f3e4aa4bd1715')

    _slack.send_message(inspect.stack()[0][3], 'Test')
